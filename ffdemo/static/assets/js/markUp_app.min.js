...
"#/"+b.linear_root+"/country/"+b.country_code+"/"+c.country_last_mark)):(a("#first-mark-link").click(function(a){a.preventDefault();b.currentMark.reference==c.first_mark?modules.linear.fn.centerCurrentMark(d,function(){modules.linear.fn.showMarkInformation(d)}):d.app.setLocation("#/"+b.linear_root+"/"+c.first_mark)}),a("#last-mark-link").click(function(a){a.preventDefault();b.currentMark.reference==c.last_mark?modules.linear.fn.centerCurrentMark(d,function(){modules.linear.fn.showMarkInformation(d)}):
...
a.modules.linear;a.currentMark&&a.currentMark.reference&&window.open("/gml/"+a.currentMark.reference)},flagCurrentMark:function(d){var b=d.modules.linear;b.currentMark.reference in b.flaggings||a.ajax({url:"/requests/flag_mark",data:{reference:b.currentMark.reference},type:"POST",dataType:"JSON",success:function(){a("#mark-flag").addClass("disabled");b.flaggings[b.currentMark.reference]=!0;d.fn.storeData("markFlaggings",b.flaggings)},error:function(){d.fn.showError(d.fn.getString("error-msg"),"#/linear/")}})},
deleteCurrentMark:function(d){var b=d.modules.linear;a.ajax({url:"/requests/delete_mark",data:{reference:b.currentMark.reference},type:"POST",dataType:"JSON",success:function(){var a=b.currentMark.reference,e=null;delete b.marks[b.currentMark.reference];b.currentMark=null;for(var f=0;f<b.scene.objects.length;f++)if(e||b.scene.objects[f].reference==a){if(!e)e=f,b.scene.objects.splice(f,1),b.currentMark=b.scene.objects[f];f==0?b.scene.objects[f].positionToStart():b.scene.objects[f].positionRelativeTo(b.scene.objects[f-
1])}d.app.setLocation("#/"+b.linear_root+"/"+b.currentMark.reference);b.eventChange=!0},error:function(){d.fn.showError(d.fn.getString("error-msg"),"#/linear/")}})},approveCurrentMark:function(d,b){var c=d.modules.linear;a.ajax({url:"/requests/approve_mark",data:{reference:c.currentMark.reference,should_approve:b},type:"POST",dataType:"JSON",success:function(){c.currentMark.is_approved=b},error:function(){d.fn.showError(d.fn.getString("error-msg"),"#/linear/")}})},centerCurrentMark:function(a,b){var c=
a.modules.linear;if(!c.currentMark)return!1;modules.linear.fn.showMarkInformation(a);c.cameraChange.aX=0;c.cameraChange.vX=0;c.cameraChange.aZ=0;c.cameraChange.vZ=0;var e=Math.abs(c.currentMark.position.x-c.scene.camera.position.x)/2;e=Math.max(1E3,e);var f="cameraEase"in c.tweens?c.tweens.cameraEase:new TWEEN.Tween(c.scene.camera.position);f.to({x:c.currentMark.position.x+c.currentMark.bWidth/2,y:c.currentMark.position.y+c.currentMark.bHeight/2,z:c.currentMark.position.z-1E3},e).onComplete(function(){delete c.tweens.cameraEase;
typeof b==="function"&&b(this)}).easing(e>1200?TWEEN.Easing.Quadratic.EaseInOut:TWEEN.Easing.Quartic.EaseInOut).start();c.tweens.cameraEase=f}}}})(jQuery);
...
a("#cursor-tooltip");b.$cursorTooltip.fadeIn("fast").find("p").text(b.fn.getString("cursor-tooltip-capture-msg")).end();setTimeout(function(){var a=b.$cursorTooltip;delete b.$cursorTooltip;a.fadeOut("fast")},5E3)},endIntro:function(a){a.app.setLocation("#/mark/new")},locationDialogToggle:function(b){b.preventDefault();a("#location-dialog").is(":visible")?a("#location-dialog").fadeOut("fast"):a("#location-dialog").fadeIn("fast").css({bottom:a("#markmaker-location").height()+25,left:a("#markmaker-location").offset().left+
32})},informationDialogToggle:function(b){b.preventDefault();b.type=="mouseout"?a("#information-dialog").fadeOut("fast"):a("#information-dialog").fadeIn("fast").css({bottom:a("#markmaker-information").height()+36,left:a("#markmaker-information").offset().left-a("#information-dialog").width()+30})},startMark:function(b){var c=b.modules.capture;c.captureTime=(new Date).getTime();c.rtl=b.mouseX>a(window).width()/2;c.mark=new Mark.gmlMark([],"","",c.captureTime,c.rtl);a("#markmaker-submit a, #markmaker-reset a").removeClass("disabled")},
endMark:function(a){a.modules.capture.mark.setupVars()},startStroke:function(a){a=a.modules.capture;a.currentStroke=[];if(a.strokes.length>0)a.captureTime=(new Date).getTime()-(a.strokes[a.strokes.length-1][a.strokes[a.strokes.length-1].length-1].time+a.timeBetweenStrokes)},endStroke:function(a){var c=a.modules.capture;if(c.currentStroke.length>2){c.strokes.push(c.currentStroke);var e=Mark.simplification.simplifyPath(c.currentStroke,1);e=Mark.simplification.weightPath(e,[5,10,20,40]);c.mark.strokes.push(e);
c.cleanedStrokes.push(e);d.capture.fn.drawStroke(a,e);c.capturedPoints-=c.currentStroke.length-e.length}c.currentStroke=null},capturePoint:function(a){var c=a.modules.capture;if(c.capturedPoints>c.captureLimit)a.fn.trigger("mouseup"),d.capture.fn.closeShop(a);else{var e=(new Date).getTime();a=new Mark.gmlPoint(a.mouseX,a.mouseY,e-c.captureTime,0);c.currentStroke.length>0?(e=c.currentStroke[c.currentStroke.length-1],a.speed=e.speedToPoint(a),a.setAngleFromPoint(e),a.smoothAgainst(e,0.01)):c.strokes.length>=
1&&d.capture.fn.drawGuide(c.layerManager.layers.drawnLayer.context,c.lastX,c.lastY,a.x,a.y);c.currentStroke.push(a);c.lastX=a.x;c.lastY=a.y;c.capturedPoints++}},reset:function(b){b=b.modules.capture;b.layerManager.layers.liveDrawingLayer.clean();b.layerManager.layers.drawnLayer.clean();b.capturedPoints=0;b.rtl=null;b.mouseDown=!1;b.lastX=null;b.lastY=null;b.strokes=[];b.currentStroke=null;b.mark=null;b.captureTime=null;b.state="drawing";a("#markmaker-submit a, #markmaker-reset a").addClass("disabled");
...
a.modules.capture;c.layerManager.layers.liveDrawingLayer.clean();a.mouseIn&&(c.state=="drawing"||c.state=="intro")?(d.capture.fn.drawCursor(c.layerManager.layers.liveDrawingLayer.context,a.mouseX,a.mouseY,(c.captureLimit-c.capturedPoints)/c.captureLimit),a.$cursorTooltip&&a.$cursorTooltip.fadeIn().css({top:a.mouseY-a.$cursorTooltip.height()-32,left:a.mouseX+8})):a.mouseIn||a.$cursorTooltip&&a.$cursorTooltip.fadeOut()},introLoop:function(){},drawLoop:function(b){var c=b.modules.capture;if(c.currentStroke&&
c.currentStroke.length>0)Mark.thickBrush(c.layerManager.layers.liveDrawingLayer.context,[c.currentStroke]),c.layerManager.layers.liveDrawingLayer.context.fillStyle="rgba(255,255,255,0.3)",c.layerManager.layers.liveDrawingLayer.context.strokeStyle="rgba(255,255,255,0.3)",Mark.circleBrush(c.layerManager.layers.liveDrawingLayer.context,[c.currentStroke]);if(b.mouseIn&&!b.mouseDown){var e,f;c.strokes.length==0?(e=b.mouseX>a(window).width()/2?c.layerManager.layers.liveDrawingLayer.canvas.width:0,f=b.mouseY):
(e=c.lastX,f=c.lastY);d.capture.fn.drawGuide(c.layerManager.layers.liveDrawingLayer.context,e,f,b.mouseX,b.mouseY)}}}}})(jQuery);
...
Mark.renderer.renderScene(b.vizScene,{width:a.width,height:a.height});if(b.curLocaleMark||b.xMark){b.layerManager.layers.mainMark.clean();if(b.curLocaleMark){var c=500/b.curLocaleMark.bWidth;Mark.renderer.renderMark(b.layerManager.layers.mainMark.context,b.curLocaleMark,{offset:{x:a.width/2-115,y:a.height-240},scale:{x:c,y:c,thickness:c},color:"255,84,0",timer:b.textScene.timers[b.curLocaleMark.reference]})}b.xMark&&Mark.renderer.renderMark(b.layerManager.layers.mainMark.context,b.xMark,{offset:{x:10,
y:-400},scale:{x:a.width/2/b.xMark.bWidth,y:(a.height+800)/b.xMark.bHeight,thickness:6},color:"0,0,0",timer:b.textScene.timers[b.xMark.reference]})}},ready:function(d){a("#markmaker").hide().children().hide();a.when(modules.intro.fn.initInterface(d),modules.intro.fn.loadMarks(d)).then(function(){modules.intro.fn.runVizPreview(d)}).then(function(){modules.intro.fn.startDomAnimation(d)}).fail(function(){modules.intro.fn.simpleIntro(d)})}},fn:{init:function(d,b){var c=d.modules.intro;if(c.initialized)for(option in a.extend(c,
...
"slow").delay(2E3).animate({opacity:"0.1"},"slow");a("#markmaker").delay(3E3)}},startDomAnimation:function(d){a("#markmaker").width(0).show().animate({width:d.width},"slow",function(){modules.intro.fn.startMarkAnimations(d);a("#intro-main-copy").fadeIn("slow");a("#click-anywhere").delay(200).fadeIn("slow");a("#browse-marks").delay(100).fadeIn("slow")});setTimeout(function(){d.$cursorTooltip=a("#cursor-tooltip").find("p").text(d.fn.getString("cursor-tooltip-intro-msg")).end().css({top:-400}).fadeIn("fast")},
3E3)},startMarkAnimations:function(d){d=d.modules.intro;a("#the-big-x").fadeIn("slow");if(d.curLocaleMark){var b=(new Date).getTime()+2E3;d.textScene.timers[d.curLocaleMark.reference]={start:b,end:b+d.curLocaleMark.maxTime,speed:2}}},simpleIntro:function(d){a("#markmaker").width(0).show().animate({width:d.width},"slow",function(){a("#intro-main-copy").fadeIn("slow");a("#the-big-x").fadeIn("slow");a("#click-anywhere").delay(200).fadeIn("slow");a("#browse-marks").delay(100).fadeIn("slow")})}}}})(jQuery);
