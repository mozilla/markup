...
a.mouseX,a.mouseY,(c.captureLimit-c.capturedPoints)/c.captureLimit),a.$cursorTooltip&&a.$cursorTooltip.fadeIn().css({top:a.mouseY-a.$cursorTooltip.height()-32,left:a.mouseX+8})):a.mouseIn||a.$cursorTooltip&&a.$cursorTooltip.fadeOut()},introLoop:function(){},drawLoop:function(b){var c=b.modules.capture;if(c.currentStroke&&c.currentStroke.length>0)Mark.thickBrush(c.layerManager.layers.liveDrawingLayer.context,[c.currentStroke]),c.layerManager.layers.liveDrawingLayer.context.fillStyle="rgba(255,255,255,0.3)",
