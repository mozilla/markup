...
function(a){return b.fn.trigger(a.type,a)}),setInterval(b.fn.loop,42);var c=a.makeArray(arguments);if(c.length>0){var e=c.shift();if(e in b.public_fn)b.public_fn[e](b,typeof c[0]=="undefined"?{}:c[0])}return d.data("markApp-context",b)}})(jQuery);
...
evt:{ready:function(a){modules.linear.fn.initInterface(a)},resize:function(a){a.modules.linear.eventChange=!0;a.modules.linear.layerManager.resizeAll(a.width,a.height)},keydown:function(a,b){var c=a.modules.linear;switch(b.keyCode){case 38:b.preventDefault();c.cameraChange.aZ=10;break;case 40:b.preventDefault();c.cameraChange.aZ=-10;break;case 39:b.preventDefault();c.cameraChange.aX=10;modules.linear.fn.hideMarkInformation(a);break;case 37:b.preventDefault(),c.cameraChange.aX=-10,modules.linear.fn.hideMarkInformation(a)}},
keyup:function(a,b){var c=a.modules.linear;switch(b.keyCode){case 38:case 40:b.preventDefault();c.cameraChange.aZ=0;break;case 39:case 37:b.preventDefault(),c.cameraChange.aX=0}},keypress:function(a,b){switch(b.keyCode){case 38:case 40:case 39:case 37:b.preventDefault()}},mousedown:function(a){var b=a.modules.linear;if(mark=modules.linear.fn.hitTest(a,a.mouseX,a.mouseY))mark==b.currentMark?modules.linear.fn.centerCurrentMark(a,function(){modules.linear.fn.showMarkInformation(a)}):b.country_code?a.app.setLocation("#/"+
b.linear_root+"/country/"+b.country_code+"/"+mark.reference):a.app.setLocation("#/"+b.linear_root+"/"+mark.reference)},mousemove:function(d){var b=d.modules.linear;b.eventChange=!0;if(mark=modules.linear.fn.hoverTest(d,d.mouseX,d.mouseY,b.hoverMark)){if(b.hoverMark)b.hoverMark.color=b.hoverMark.contributor_name?"0,139,211":"0,0,0";b.hoverMark=mark;b.currentMark&&b.hoverMark.reference==b.currentMark.reference&&b.hoverMark.contributor_name&&a("#mark-information").is(":visible")?a("#contributor-quote-box").is(":not(:visible)")&&
a("#contributor-quote-box").fadeIn("fast").css({left:d.mouseX-15,top:d.mouseY-a("#contributor-quote-box").height()-15}):(a("#contributor-quote-box:visible").fadeOut("fast"),b.hoverMark.color="255,111,40")}else if(b.hoverMark)b.hoverMark.color=b.hoverMark.contributor_name?"0,139,211":"0,0,0",b.hoverMark=null,a("#contributor-quote-box:visible").fadeOut("fast")},loop:function(d){var b=d.modules.linear,c=b.layerManager.layers.drawingLayer,e={x:b.scene.camera.position.x,y:b.scene.camera.position.y,z:b.scene.camera.position.z};
...
modules.linear.fn.hideMarkInformation(d)});d.fn.withCountryCodes(function(c){for(var e=a("#country-select"),f=0;f<c.length;f++){var g=a("<option />").val(c[f].code).text(c[f].name);e.append(g)}e.change(function(){var c=a(this).val();c.length!=2&&b.country_code?d.app.setLocation("#/"+b.linear_root+"/"):c.length==2&&c!=b.country_code&&d.app.setLocation("#/"+b.linear_root+"/country/"+c+"/");a(this).blur();a(".ui-selectBox-focus").removeClass("ui-selectBox-focus");d.$container.focus()});b.country_code&&
e.val(b.country_code)});a("#mark-information").hide();a("#mark-playback").click(function(a){a.preventDefault();modules.linear.fn.replayCurrentMark(d)});a("#mark-gml-download").click(function(a){a.preventDefault();modules.linear.fn.downloadCurrentMark(d)});a("#mark-flag").click(function(a){a.preventDefault();modules.linear.fn.flagCurrentMark(d)});a("#delete-mark").click(function(a){a.preventDefault();modules.linear.fn.deleteCurrentMark(d)});a("#approve-mark-checkbox").change(function(b){b.preventDefault();
b=a(this).is(":checked");modules.linear.fn.approveCurrentMark(d,b)});a("#twitter-share").socialShare({share_url:"http://twitter.com/share",share_params:{text:d.fn.getString("twitter-msg")}});a("#facebook-share").socialShare({share_url:"http://www.facebook.com/sharer.php",share_params:{t:d.fn.getString("facebook-msg")}});modules.linear.fn.updateInterface(d);modules.linear.fn.initMarks(d);a("#sammy #country-select").selectBox({autoWidth:!1});a("#sammy #contributor-select").selectBox({autoWidth:!1})},
...
modules.linear.fn.loadMarks(a,{offset:0,max:20,success:function(c){if(c.success){if(modules.linear.fn.setupMarks(a,c.marks),firstMark=b.marks[b.rightBuffer[0]])b.scene.camera.position.x=-4E3,b.scene.camera.position.z=-3E3,c="cameraEase"in b.tweens?b.tweens.cameraEase:new TWEEN.Tween(b.scene.camera.position),c.to({x:firstMark.bWidth/2,y:firstMark.bHeight/2,z:-1E3},2E3).onComplete(function(){delete b.tweens.cameraEase;typeof callback==="function"&&callback(this)}).easing(TWEEN.Easing.Quartic.EaseInOut).start(),
b.tweens.cameraEase=c}else a.fn.showError(a.fn.getString("no-marks-error-msg"),"#/linear/");b.requestingMarks=!1}})},updateInterface:function(d){var b=d.modules.linear,c=d.fn.getData("userMark");c&&(b.country_code?c.country_code==b.country_code:1)?a("#your-mark-link").attr("href","#/"+b.linear_root+"/"+d.fn.getData("userMark").reference).show():a("#your-mark-link").hide();var e={};b.country_code?(e.country_code=b.country_code,a("#contributor-select").next().hide(),a("#contributor-select-label").hide()):
(a("#contributor-select").next().show(),a("#contributor-select-label").show());b.linear_root!="moderate"&&!a("#mark-browsing-options").is(".country-"+(b.country_code?b.country_code:"all"))&&a.ajax({url:"/requests/init_viz_data",data:e,dataType:"JSON",success:function(c){a("#mark-browsing-options").removeAttr("class").addClass("country-"+(b.country_code?b.country_code:"all"));b.country_code?(a("#first-mark-link").attr("href","#/"+b.linear_root+"/country/"+b.country_code+"/"+c.country_first_mark),a("#last-mark-link").attr("href",
"#/"+b.linear_root+"/country/"+b.country_code+"/"+c.country_last_mark)):(a("#first-mark-link").click(function(a){a.preventDefault();b.currentMark!=null&&b.currentMark.reference==c.first_mark?modules.linear.fn.centerCurrentMark(d,function(){modules.linear.fn.showMarkInformation(d)}):d.app.setLocation("#/"+b.linear_root+"/"+c.first_mark)}),a("#last-mark-link").click(function(a){a.preventDefault();b.currentMark!=null&&b.currentMark.reference==c.last_mark?modules.linear.fn.centerCurrentMark(d,function(){modules.linear.fn.showMarkInformation(d)}):
d.app.setLocation("#/"+b.linear_root+"/"+c.last_mark)}));a("#mark-browsing").collapsibleMod();a("#total-mark-count").text(c.max_id);if(a("#contributor-select option").size()==1){var g=a("#contributor-select");if(c.contributor_marks)for(var h=0;h<c.contributor_marks.length;h++){var i=a("<option />").val(c.contributor_marks[h].reference).text(c.contributor_marks[h].contributor);g.append(i)}g.change(function(){var c=a(this).val();c!="label"&&d.app.setLocation("#/"+b.linear_root+"/"+c);a(this).blur();
d.$container.focus()});b.country_code?(e.country_code=b.country_code,a("#contributor-select").next().hide(),a("#contributor-select-label").hide()):(a("#contributor-select").next().show(),a("#contributor-select-label").show())}}})},dumpAllMarks:function(a){a=a.modules.linear;for(mark in a.marks)delete a.marks[mark];a.scene.objects=[];a.leftBuffer=[];a.rightBuffer=[];a.moreRight=!0;a.moreLeft=!0;a.scene.camera.position.x=0;a.scene.camera.position.y=0;a.scene.camera.position.z=-1E3},loadMarks:function(d,
b){var c=d.modules.linear,e=b.success;delete b.success;if(c.country_code)b.country_code=c.country_code;var f=b.reference?"/requests/marks_by_reference":"/requests/all_marks";c.is_flagged&&(f="/requests/marks_by_flagged");b.reference&&!(b.reference in c.marks)&&modules.linear.fn.dumpAllMarks(d);if(!b.reference||b.reference&&!(b.reference in c.marks)){var g=d.fn.getString("default-loading-msg");if(c.show_thanks)c.show_thanks=!1,g=d.fn.getString("submission-thanks-loading-msg");d.fn.showLoader(d.fn.getString("loading-marks-msg"),
"overlay-light",g)}else d.fn.showLoader(d.fn.getString("loading-marks-msg"),"overlay-light",d.fn.getString("default-loading-msg"),4E3);a.ajax({url:f,data:b,dataType:"JSON"}).success(e).success(function(){d.fn.hideLoader()}).error(function(){d.fn.showError(d.fn.getString("error-msg"),"#/linear/")})},setupMarks:function(a,b){var c=a.modules.linear;if(b.length!=0){for(var e=0;e<b.length;e++)b[e].reference in c.marks&&b.shift(e,1);if(b.length!=0){e=[];for(var f in c.marks)e.push([f,c.marks[f].id]);e.sort(function(a,
b){return a[1]-b[1]});var g=e.length==0||e[0][1]<b[0].id?c.rightBuffer:c.leftBuffer,h=g==c.leftBuffer?!0:!1;h&&b.reverse();var i=g.length>0?c.marks[g[h?0:g.length-1]]:c.scene.objects[h?0:c.scene.objects.length-1];for(e=0;e<b.length;e++)if(!(b[e].reference in c.marks||typeof b[e].points_obj_simplified==="undefined"||b[e].points_obj_simplified==null||b[e].points_obj_simplified=="")){var j=JSON.parse(b[e].points_obj_simplified);if(!(j==null||!("strokes"in j)||j.strokes.length==0||j.strokes[0].length<
2)){f=new Mark.gmlMark(j.strokes,b[e].reference,b[e].country_code,b[e].date_drawn,j.rtl,b[e].id,b[e].is_approved);if(b[e].contributor)f.contributor_name=b[e].contributor,f.extra_info=j.extra_info,f.contributor_url=j.contributor_url,f.color="0,139,211";c.marks[f.reference]=f;i&&f.positionRelativeTo(i,h);h?g.unshift(f.reference):g.push(f.reference);i=f}}}}},refillBuffer:function(a,b){var c=a.modules.linear;if(!c.requestingMarks){c.requestingMarks=!0;var e=b==c.leftBuffer,f=null;f=b.length>0?c.marks[b[e?
0:b.length-1]]:c.scene.objects[e?0:c.scene.objects.length-1];modules.linear.fn.loadMarks(a,{reference:f.reference,include_forward:e?0:20,include_back:e?20:0,include_mark:0,success:function(b){b.success?(modules.linear.fn.setupMarks(a,b.marks),b.marks.length<18&&(c[e?"moreLeft":"moreRight"]=!1)):c[e?"moreLeft":"moreRight"]=!1;c.requestingMarks=!1}})}},updateBuffers:function(a,b,c){var e=a.modules.linear;if(e.scene.objects.length!=0){for(var f=e.scene.objects[0];f&&f.position.x+f.bWidth<b;)e.leftBuffer.push(e.scene.objects.shift().reference),
...
0)for(var e=a.marks[a.rightBuffer[0]];e&&e.position&&e.position.x<c;)a.scene.objects.push(a.marks[a.rightBuffer.shift()]),e=a.rightBuffer[0];if(a.leftBuffer.length>0)for(e=a.marks[a.leftBuffer[a.leftBuffer.length-1]];e&&e.position&&e.position.x+e.bWidth>b;)a.scene.objects.unshift(a.marks[a.leftBuffer.pop()]),e=a.leftBuffer[a.leftBuffer.length-1]},jumpToMark:function(a,b,c){var e=a.modules.linear;e.currentMark=e.marks[b];if(c){var f=(new Date).getTime()*2;e.scene.timers[b]={start:f,end:f+e.currentMark.maxTime,
speed:1}}modules.linear.fn.centerCurrentMark(a,function(){c&&modules.linear.fn.replayCurrentMark(a);modules.linear.fn.showMarkInformation(a)})},closestMark:function(a){a=a.modules.linear;for(var b=a.scene.objects[0],c=1;c<a.scene.objects.length;c++){var e=a.scene.objects[c];Math.abs(a.scene.camera.position.x-(e.position.x+e.bWidth/2))<Math.abs(a.scene.camera.position.x-(b.position.x+b.bWidth/2))&&(b=e)}return b},hoverTest:function(a,b,c,e){if(e&&e.renderedBounds&&b>=e.renderedBounds.minX&&b<=e.renderedBounds.maxX&&
c>=e.renderedBounds.minY&&c<=e.renderedBounds.maxY)return e;return modules.linear.fn.hitTest(a,b,c)},hitTest:function(a,b,c){a=a.modules.linear;for(var e=0;e<a.scene.objects.length;e++)if(a.scene.objects[e].renderedBounds&&b>=a.scene.objects[e].renderedBounds.minX&&b<=a.scene.objects[e].renderedBounds.maxX&&c>=a.scene.objects[e].renderedBounds.minY&&c<=a.scene.objects[e].renderedBounds.maxY)return a.scene.objects[e];return!1},showMarkInformation:function(d){var b=d.modules.linear;if(!b.currentMark)return!1;
var c=b.currentMark;a("#mark-id").text(c.id);var e=new Date(c.time);e=new Date(e.getTime()+36E5*d.timezoneOffset);var f=[];f.push(e.getHours()+":"+(String(e.getMinutes()).length==1?"0"+e.getMinutes():e.getMinutes()));f.push("GMT");f.push(d.fn.getString("month-abbreviations",e.getMonth())+" "+e.getDate()+", "+e.getFullYear());c.country_code?d.fn.withCountryCodes(function(b){c.country_code in b?a("#mark-country").text(" / "+b[c.country_code]):a("#mark-country").text("")}):a("#mark-country").text("");
c.contributor_name?(a("#mark-contributor-name").text(c.contributor_name),a("#contributor-name").text(c.contributor_name),a("#mark-flag").hide(),"extra_info"in c&&c.extra_info!=null&&c.extra_info!=""&&a("#contributor-quote").text("\u201c"+c.extra_info+"\u201d"),"contributor_url"in c&&d.fn.validate.url(c.contributor_url)?a("#mark-contributor-url").text(c.contributor_url.replace(/(ftp|http|https):\/\//,"").replace(/\/$/,"")).attr("href",c.contributor_url):a("#mark-contributor-url").text("").attr("href",
""),a("#contributor-information").show()):(a("#mark-contributor-name, #contributor-quote, #contributor-name, #mark-contributor-url").text(""),a("#contributor-information").hide(),a("#mark-flag").show());a("#mark-timestamp").text(f.join(" "));a("#url-share input").val(window.location.href);if(b.linear_root!="moderate")a("#twitter-share").data("socialShare-context").share_params.url=window.location.href,a("#facebook-share").data("socialShare-context").share_params.u=window.location.href;b.linear_root==
"moderate"&&a("#approve-mark-checkbox").attr("checked",c.is_approved);b.currentMark!=null&&b.currentMark.reference in b.flaggings?a("#mark-flag").addClass("disabled"):a("#mark-flag").removeClass("disabled");a("#mark-information").fadeIn("fast")},resetMarkInformation:function(){a("#mark-information").find("a").attr("href","#").end().find("#mark-id, #total-mark-count, #mark-timestamp, #mark-country")},hideMarkInformation:function(){a("#mark-information").fadeOut("fast")},replayCurrentMark:function(a){a=
a.modules.linear;var b=(new Date).getTime();a.eventChange=!0;a.scene.timers[a.currentMark.reference]={start:b,end:b+a.currentMark.maxTime,speed:1}},downloadCurrentMark:function(a){a=a.modules.linear;a.currentMark!=null&&a.currentMark.reference&&window.open("/gml/"+a.currentMark.reference)},flagCurrentMark:function(d){var b=d.modules.linear;b.currentMark!=null&&b.currentMark.reference in b.flaggings||a.ajax({url:"/requests/flag_mark",data:{reference:b.currentMark.reference},type:"POST",dataType:"JSON",
success:function(){a("#mark-flag").addClass("disabled");b.flaggings[b.currentMark.reference]=!0;d.fn.storeData("markFlaggings",b.flaggings)},error:function(){d.fn.showError(d.fn.getString("error-msg"),"#/linear/")}})},deleteCurrentMark:function(d){var b=d.modules.linear,c=b.currentMark.reference;a.ajax({url:"/requests/delete_mark",data:{reference:c},type:"POST",dataType:"JSON",success:function(){modules.linear.fn.removeMarkFromScreen(d,c);b.currentMark=null;modules.linear.fn.hideMarkInformation(d)},
error:function(){d.fn.showError(d.fn.getString("error-msg"),"#/linear/")}})},approveCurrentMark:function(d,b){var c=d.modules.linear,e=c.currentMark.reference;a.ajax({url:"/requests/approve_mark",data:{reference:e,should_approve:b},type:"POST",dataType:"JSON",success:function(){modules.linear.fn.removeMarkFromScreen(d,e);c.currentMark=null;modules.linear.fn.hideMarkInformation(d)},error:function(){d.fn.showError(d.fn.getString("error-msg"),"#/linear/")}})},removeMarkFromScreen:function(a,b){for(var c=
a.modules.linear,e=null,f=0;f<c.scene.objects.length;f++)if(e||c.scene.objects[f].reference==b)e?f==0?c.scene.objects[f].positionToStart():c.scene.objects[f].positionRelativeTo(c.scene.objects[f-1]):(e=f,c.scene.objects.splice(f,1));c.eventChange=!0},centerCurrentMark:function(a,b){var c=a.modules.linear;if(c.currentMark){modules.linear.fn.showMarkInformation(a);c.cameraChange.aX=0;c.cameraChange.vX=0;c.cameraChange.aZ=0;c.cameraChange.vZ=0;var e=Math.abs(c.currentMark.position.x-c.scene.camera.position.x)/
2;e=Math.max(1E3,e);var f="cameraEase"in c.tweens?c.tweens.cameraEase:new TWEEN.Tween(c.scene.camera.position);f.to({x:c.currentMark.position.x+c.currentMark.bWidth/2,y:c.currentMark.position.y+c.currentMark.bHeight/2,z:c.currentMark.position.z-1E3},e).onComplete(function(){delete c.tweens.cameraEase;typeof b==="function"&&b(this)}).easing(e>1200?TWEEN.Easing.Quadratic.EaseInOut:TWEEN.Easing.Quartic.EaseInOut).start();c.tweens.cameraEase=f}else return c.eventChange=!0,!1}}}})(jQuery);
...
0)for(var e=0;e<c.mark.strokes.length;e++)d.capture.fn.drawStroke(a,c.mark.strokes[e])},mousemove:function(a){d.capture.fn.commonLoop(a);a.mouseDown&&a.modules.capture.state=="drawing"&&d.capture.fn.capturePoint(a)},mousedown:function(b){switch(b.modules.capture.state){case "drawing":a("#markmaker-controls, #contributor-fields, #translator-fields, #markmaker-legal-line").css("zIndex",0);a("#location-dialog").is(":visible")&&a("#location-dialog").fadeOut("fast");b.modules.capture.mark||d.capture.fn.startMark(b);
b.modules.capture.currentStroke||d.capture.fn.startStroke(b);break;case "intro":b.modules.capture.mark||d.capture.fn.startMark(b),b.modules.capture.currentStroke||d.capture.fn.startStroke(b),d.capture.fn.endIntro(b)}},mouseup:function(b){b.modules.capture.state=="drawing"&&(d.capture.fn.endStroke(b),a("#markmaker-controls, #contributor-fields, #translator-fields, #markmaker-legal-line").css("zIndex",200))},mouseout:function(a){a.modules.capture.layerManager.layers.cursorLayer.clean();if(a.$cursorTooltip)clearTimeout(a.tooltipFader),
a.tooltipFader=setTimeout(function(){a.$cursorTooltip.stop(!0,!0).fadeOut("fast")},100)},mouseover:function(a){if(a.$cursorTooltip)clearTimeout(a.tooltipFader),a.tooltipFader=setTimeout(function(){a.$cursorTooltip.stop(!0,!0).fadeIn("fast")},100)},ready:function(b){var c=b.modules.capture;a("#markmaker").hide().children().hide();a("#markmaker-reset a").addClass("disabled").bind("mousedown",function(a){a.preventDefault();d.capture.fn.reset(b)});a("#markmaker-submit a").addClass("disabled").bind("mousedown",
function(c){c.preventDefault();a(this).is(":not(.disabled)")&&d.capture.fn.submit(b)});b.fn.withCountryCodes(function(b){for(var c=a("#markmaker-country"),d=0;d<b.length;d++){var h=a("<option />").val(b[d].code).text(b[d].name);c.append(h)}});a("#markmaker-location a").bind("mousedown",{context:b},d.capture.fn.locationDialogToggle);a("#markmaker-information").bind("mouseover",{context:b},d.capture.fn.informationDialogToggle).bind("mouseout",{context:b},d.capture.fn.informationDialogToggle);c.state==
"drawing"&&d.capture.fn.initDrawing(b);a("#sammy #markmaker-country").selectBox({autoWidth:!1})},loop:function(a){var c=a.modules.capture;if(c.initialized)switch(c.frameCount++,a.modules.capture.state){case "drawing":d.capture.fn.drawLoop(a)}}},fn:{init:function(b,c){var e=b.modules.capture;if("$capture"in e){if("state"in c)d.capture.fn.reset(b),c.state=="drawing"&&b.mouseDown&&b.fn.trigger("mousedown"),e.state=c.state,d.capture.fn.initDrawing(b)}else a.extend(e,d.capture.defaults),a.extend(e,c),
a.extend(e,d.capture.config),e.$capture=a("<div />").addClass("capture-container"),b.$container.css({zIndex:100,cursor:"none"}).append(e.$capture),e.layerManager=new Mark.layerManager(e.$capture.get(0)),e.layerManager.addLayer("drawnLayer"),e.layerManager.addLayer("cursorLayer"),e.layerManager.addLayer("liveDrawingLayer"),b.fn.trigger("resize"),e.initialized=!0},deinit:function(a){var c=a.modules.capture;c.$capture.fadeOut("fast",function(){c.layerManager.removeAll();c.$capture.remove();c.initialized=
!1})},initDrawing:function(b){var c=b.modules.capture;a("#browse-marks").is(":visible")&&(a("#browse-marks, #click-anywhere, #intro-main-copy, #the-big-x").fadeOut("fast"),a("#markmaker-legal-line").fadeIn("slow"));a("#markmaker").css("background-position","0 "+(b.height-140)+"px");a("#markmaker").unbind("resize.markApp").bind("resize.markApp",function(){a("#markmaker").css("background-position","0 "+(b.height-140)+"px");a("#location-dialog:visible").size()>0&&a("#location-dialog:visible").css({bottom:a("#markmaker-location").height()+
25,left:a("#markmaker-location").offset().left+32})});a("#markmaker").is(":visible")?a("#markmaker-controls").fadeIn("slow",function(){a("#markmaker-information").fadeIn("slow")}):a("#markmaker").width(0).show().animate({width:b.width},"slow",function(){a("#markmaker-controls").fadeIn("slow",function(){a("#markmaker-information").fadeIn("slow")});a("#markmaker-legal-line").fadeIn("slow")});a("#save-location-button").click(function(b){b.preventDefault();a("#location-dialog").fadeOut();return!1});c.invite_code&&
c.contributor_type=="t"?(c.captureLimit=1E3,c.$capture.addClass("translator"),a("#translator-fields").find("#translator-locale").text("'"+b.locale+"'").end().show().collapsibleMod().hide().fadeIn("slow")):c.invite_code&&c.contributor_type=="c"&&(c.$capture.addClass("contributor"),a("#contributor-fields").show().collapsibleMod().hide().fadeIn("slow"));b.$cursorTooltip=b.$cursorTooltip||a("#cursor-tooltip");b.$cursorTooltip.fadeIn("fast").find("p").text(b.fn.getString("cursor-tooltip-capture-msg")).end();
setTimeout(function(){var a=b.$cursorTooltip;delete b.$cursorTooltip;a.stop(!0,!0).fadeOut("fast")},5E3)},endIntro:function(a){a.app.setLocation("#/mark/new")},locationDialogToggle:function(b){b.preventDefault();a("#location-dialog").is(":visible")?a("#location-dialog").fadeOut("fast"):a("#location-dialog").fadeIn("fast").css({bottom:a("#markmaker-location").height()+25,left:a("#markmaker-location").offset().left+32})},informationDialogToggle:function(b){b.preventDefault();b.type=="mouseout"?a("#information-dialog").fadeOut("fast"):
a("#information-dialog").fadeIn("fast").css({bottom:a("#markmaker-information").height()+36,left:a("#markmaker-information").offset().left-a("#information-dialog").width()+30})},startMark:function(b){var c=b.modules.capture;c.captureTime=(new Date).getTime();c.rtl=b.mouseX>a(window).width()/2;c.mark=new Mark.gmlMark([],"","",c.captureTime,c.rtl)},endMark:function(a){a.modules.capture.mark.setupVars()},startStroke:function(a){a=a.modules.capture;a.currentStroke=[];if(a.strokes.length>0)a.captureTime=
(new Date).getTime()-(a.strokes[a.strokes.length-1][a.strokes[a.strokes.length-1].length-1].time+a.timeBetweenStrokes)},endStroke:function(b){var c=b.modules.capture;if(c.currentStroke.length>=4){if(c.mark.strokes.length==0)a("#markmaker-submit a, #markmaker-reset a").removeClass("disabled");else{var e=c.mark.strokes[c.mark.strokes.length-1];d.capture.fn.drawGuide(c.layerManager.layers.drawnLayer.context,e[e.length-1].x,e[e.length-1].y,c.currentStroke[0].x,c.currentStroke[0].y)}c.strokes.push(c.currentStroke);
e=Mark.simplification.simplifyPath(c.currentStroke,1);e=Mark.simplification.weightPath(e,[5,10,20,40]);c.mark.strokes.push(e);c.cleanedStrokes.push(e);d.capture.fn.drawStroke(b,e);c.capturedPoints-=c.currentStroke.length-e.length}c.currentStroke=null},capturePoint:function(a){var c=a.modules.capture;if(c.capturedPoints>c.captureLimit)a.fn.trigger("mouseup"),d.capture.fn.closeShop(a);else{var e=(new Date).getTime();a=new Mark.gmlPoint(a.mouseX,a.mouseY,e-c.captureTime,0);if(c.currentStroke.length>
0)e=c.currentStroke[c.currentStroke.length-1],a.speed=e.speedToPoint(a),a.setAngleFromPoint(e),a.smoothAgainst(e,0.01);c.currentStroke.push(a);c.lastX=a.x;c.lastY=a.y;c.capturedPoints++}},reset:function(b){b=b.modules.capture;b.layerManager.layers.liveDrawingLayer.clean();b.layerManager.layers.drawnLayer.clean();b.capturedPoints=0;b.rtl=null;b.mouseDown=!1;b.lastX=null;b.lastY=null;b.strokes=[];b.currentStroke=null;b.mark=null;b.captureTime=null;b.state="drawing";a("#markmaker-submit a, #markmaker-reset a").addClass("disabled");
a("#markapp").css({cursor:"none"});a("#markmaker-instructions").fadeIn()},closeShop:function(b){var c=b.modules.capture;c.state="preview";d.capture.fn.endMark(b);c.layerManager.layers.liveDrawingLayer.clean();b=c.layerManager.layers.liveDrawingLayer.context;var e=c.lastX,f=c.lastY;b.strokeStyle="rgba(0,0,0,0.2)";b.lineWidth=1;b.beginPath();b.dashedLineTo(e,f,c.rtl?0:c.layerManager.layers.liveDrawingLayer.canvas.width,f,[7,5]);b.closePath();b.stroke();a("#markapp").css({cursor:"default"})},submit:function(b){var c=
b.modules.capture;if(!(c.state=="submitting"||c.mark==null||c.mark.strokes.length==0)){c.state!="preview"&&d.capture.fn.closeShop(b);c.state="submitting";a("#markmaker-submit a").addClass("disabled");var e={};e.rtl=c.rtl;e.strokes=c.strokes;e=JSON.stringify(e);var f=JSON.stringify(c.mark),g=a("#markmaker-country").val()=="label"?"":a("#markmaker-country").val();b.fn.showLoader(b.fn.getString("submitting-mark"));var h={points_obj:e,points_obj_simplified:f,country_code:g};if(c.invite_code&&c.contributor_type==
"t")h.contributor_locale=b.locale,h.invite=c.invite_code;else if(c.invite_code&&c.contributor_type=="c")h.contributor=a("#contributor-name").val(),c.mark.extra_info=a("#contributor-quote").val(),c.mark.contributor_url=a("#contributor-url").val(),h.points_obj_simplified=JSON.stringify(c.mark),h.invite=c.invite_code;a.ajax({url:"/requests/save_mark",data:h,type:"POST",dataType:"JSON",success:function(a){h.contributor_locale?b.app.setLocation("#/linear/"):(b.fn.storeData("userMark",{reference:a.mark_reference,
country_code:g}),b.app.setLocation("#/linear/"+a.mark_reference+"?playback=true&be_grateful=true"));b.fn.hideLoader()},error:function(){b.fn.showError(b.fn.getString("submit-error"))}});return!1}},drawStroke:function(a,c){var d=a.modules.capture;Mark.thickBrush(d.layerManager.layers.drawnLayer.context,[c]);d.layerManager.layers.drawnLayer.context.fillStyle="rgba(255,255,255,0.3)";d.layerManager.layers.drawnLayer.context.strokeStyle="rgba(255,255,255,0.3)";Mark.circleBrush(d.layerManager.layers.drawnLayer.context,
[c])},drawGuide:function(a,c,d,f,g){a.strokeStyle="rgba(0,0,0,0.2)";a.lineWidth=1;a.beginPath();a.dashedLineTo(c,d,f,g,[7,5]);a.closePath();a.stroke()},drawCursor:function(a,c,d,f){a.strokeStyle="#ff5400";a.fillStyle="#000000";a.beginPath();a.moveTo(c,d);a.lineTo(c+1,d-8);a.lineTo(c+20,d-27);a.lineTo(c+23,d-23);a.lineTo(c,d);a.closePath();a.stroke();f*=18.5;f+=4.5;a.beginPath();a.moveTo(c,d);a.lineTo(c+1,d-8);a.lineTo(c+(f-3),d-(f+4));a.lineTo(c+f,d-f);a.lineTo(c,d);a.closePath();a.fill()},commonLoop:function(a){var c=
a.modules.capture;c.layerManager.layers.cursorLayer.clean();if(a.mouseIn&&(c.state=="drawing"||c.state=="intro"))d.capture.fn.drawCursor(c.layerManager.layers.cursorLayer.context,a.mouseX,a.mouseY,(c.captureLimit-c.capturedPoints)/c.captureLimit),a.$cursorTooltip&&a.$cursorTooltip.css({top:a.mouseY-a.$cursorTooltip.height()-32,left:a.mouseX+8})},drawLoop:function(b){var c=b.modules.capture;c.layerManager.layers.liveDrawingLayer.clean();if(c.currentStroke&&c.currentStroke.length>0)Mark.thickBrush(c.layerManager.layers.liveDrawingLayer.context,
[c.currentStroke]),c.layerManager.layers.liveDrawingLayer.context.fillStyle="rgba(255,255,255,0.3)",c.layerManager.layers.liveDrawingLayer.context.strokeStyle="rgba(255,255,255,0.3)",Mark.circleBrush(c.layerManager.layers.liveDrawingLayer.context,[c.currentStroke]);if(b.mouseIn)if(b.mouseDown)c.mark!=null&&c.currentStroke!=null&&c.mark.strokes.length>0&&c.currentStroke.length>0&&(f=c.mark.strokes[c.mark.strokes.length-1],d.capture.fn.drawGuide(c.layerManager.layers.liveDrawingLayer.context,f[f.length-
1].x,f[f.length-1].y,c.currentStroke[0].x,c.currentStroke[0].y));else{var e;if(c.mark==null||c.mark.strokes.length==0)e=b.mouseX>a(window).width()/2?c.layerManager.layers.liveDrawingLayer.canvas.width:0,f=b.mouseY;else{var f=c.mark.strokes[c.mark.strokes.length-1];e=f[f.length-1].x;f=f[f.length-1].y}d.capture.fn.drawGuide(c.layerManager.layers.liveDrawingLayer.context,e,f,b.mouseX,b.mouseY)}}}}})(jQuery);
...
b.textScene.timers[b.curLocaleMark.reference].end<a))b.animationComplete=!0,delete b.textScene.timers[b.curLocaleMark.reference]}},ready:function(d){a("#markmaker").hide().children().hide();a.when(modules.intro.fn.initInterface(d),modules.intro.fn.loadMarks(d)).then(function(){modules.intro.fn.runVizPreview(d)}).then(function(){modules.intro.fn.startDomAnimation(d)}).fail(function(){modules.intro.fn.simpleIntro(d)})}},fn:{init:function(d,b){var c=d.modules.intro;if(c.initialized)for(option in a.extend(c,
c,b),modules.intro.defaults)b[option]==null&&(c[option]=modules.intro.defaults[option]);else a.extend(c,modules.intro.defaults,b),a.extend(c,c,modules.intro.config),c.$intro=a("<div />").addClass("intro-container"),d.$container.append(c.$intro),c.vizScene=new Mark.scene,c.textScene=new Mark.scene,c.layerManager=new Mark.layerManager(c.$intro.get(0)),c.layerManager.addLayer("viz"),c.vizScene.canvasContext=c.layerManager.layers.viz.context,c.layerManager.addLayer("mainMark"),c.textScene.canvasContext=
c.layerManager.layers.mainMark.context,c.layerManager.addLayer("X"),d.fn.trigger("resize"),c.initialized=!0},deinit:function(a){var b=a.modules.intro;b.$intro.fadeOut("fast",function(){b.layerManager.removeAll();b.$intro.remove();b.initialized=!1})},initInterface:function(d){a("#markmaker").unbind("resize.markApp").bind("resize.markApp",function(b,c,d){b=c/2+Math.min(500,c/2-20);var f=d-140,g=!1;a("#markmaker").css("background-position","0 "+f+"px");a("#markmaker").is(":visible")||(g=!0,a("#markmaker, #browse-marks, #click-anywhere, #intro-main-copy").css({display:"block"}));
a("#browse-marks").css({top:f-50,left:b-85});a("#click-anywhere").css({top:f+12,left:b-a("#intro-main-copy").width()});a("#intro-main-copy").css({top:f-a("#intro-main-copy").height()-100,left:b-a("#intro-main-copy").width()});g&&a("#markmaker, #browse-marks, #click-anywhere, #intro-main-copy").css({display:"none"});xHeight=d+d/5;xWidth=xHeight*1.545;a("#the-big-x").css({top:-(d/5),bottom:-(d/5),left:c/2-xWidth+(xHeight-500)})}).trigger("resize.markApp",[d.width,d.height]).width(0).height(d.height)},
loadMarks:function(d){d.fn.showLoader(d.fn.getString("loading-intro-msg"),"overlay-light");return a.ajax({url:"/requests/get_translated_marks",dataType:"JSON"}).success(function(a){modules.intro.fn.setupMarks(d,a.marks);d.fn.hideLoader()}).error(function(){d.fn.hideLoader()})},setupMarks:function(d,b){var c=d.modules.intro;if(!(typeof b==="undefined"||b.length==0)){a(c.layerManager.layers.viz.canvas).css("opacity",0);b.sort(function(){return Math.round(Math.random())-0.5});for(var e=null,f=0;f<b.length;f++)try{var g=
JSON.parse(b[f].points_obj_simplified),h=new Mark.gmlMark(g.strokes,b[f].reference,b[f].country_code,b[f].date_drawn,g.rtl,b[f].id,b[f].is_approved);if(!c.currentMark)c.currentMark=h;b[f].reference in c.marks||(c.marks[h.reference]=h);e&&h.positionRelativeTo(e,!1);if(b[f].contributor_locale==d.locale||!c.curLocaleMark){var i=(new Date).getTime()*3;c.curLocaleMark=new Mark.gmlMark(g.strokes,b[f].reference,b[f].country_code,b[f].date_drawn,g.rtl,b[f].id,b[f].is_approved);c.textScene.timers[c.curLocaleMark.reference]=
{start:i,end:i+c.curLocaleMark.maxTime,speed:2}}c.vizScene.objects.push(h);e=h}catch(j){}}},runVizPreview:function(d){var b=d.modules.intro;if(!b.initialized)return!1;if(!(b.vizScene.objects.length<3)){b.vizScene.camera.position.x=-2E3;b.vizScene.camera.position.z=-3E3;d=b.vizScene.objects[b.vizScene.objects.length-2];var c=new TWEEN.Tween(b.vizScene.camera.position);c.to({x:d.position.x+d.bWidth/2,y:d.position.y+d.bHeight/2,z:d.position.z-2E3},6E3).onComplete(function(){delete b.tweens.cameraEase}).easing(TWEEN.Easing.Quartic.EaseInOut).start();
b.tweens.cameraEase=c;a(b.layerManager.layers.viz.canvas).animate({opacity:"1"},"slow").delay(2E3).animate({opacity:"0.1"},"slow");a("#markmaker").delay(3E3)}},startDomAnimation:function(d){a("#markmaker").width(0).show().animate({width:d.width},"slow",function(){modules.intro.fn.startMarkAnimations(d);a("#intro-main-copy").fadeIn("slow");a("#click-anywhere").delay(200).fadeIn("slow");a("#browse-marks").delay(100).fadeIn("slow")});setTimeout(function(){d.$cursorTooltip=a("#cursor-tooltip").find("p").text(d.fn.getString("cursor-tooltip-intro-msg")).end().css({top:-400}).fadeIn("fast")},
3E3)},startMarkAnimations:function(d){d=d.modules.intro;if(!d.initialized)return!1;a("#the-big-x").fadeIn("slow");if(d.curLocaleMark){var b=(new Date).getTime()+2E3;d.textScene.timers[d.curLocaleMark.reference]={start:b,end:b+d.curLocaleMark.maxTime,speed:2}}else d.animationComplete=!0},simpleIntro:function(d){var b=d.modules.intro;if(!b.initialized)return!1;a("#markmaker").width(0).show().animate({width:d.width},"slow",function(){a("#intro-main-copy").fadeIn("slow");a("#the-big-x").fadeIn("slow");
a("#click-anywhere").delay(200).fadeIn("slow");a("#browse-marks").delay(100).fadeIn("slow");b.animationComplete=!0})}}}})(jQuery);
...
(a(d).removeClass("ui-selectBox-focus"),a(document).unbind("mousedown",h),a(document).unbind("keydown",i),a(c).trigger("blur"),e(b))},i=function(b){var d=b.data.select,k=b.data.control,m=a("#ui-selectBox-dropdown");if(a(k).hasClass("ui-selectBox-disabled"))return!1;switch(b.keyCode){case 9:h(b);break;case 13:if(a(m).size()===0)return!1;d=a(m).find(".ui-selectBox-option");var g=-1;a.each(d,function(b,c){a(c).hasClass("ui-selectBox-current")&&(g=b)});g>=0&&f(b,a(d).eq(g));return!1;case 27:e(b,!0);break;
case 38:case 37:case 33:var i=b.keyCode===33?20:1;if(a(m).size()===0){if(b.altKey)return c(b),!1;b=a(d).find("OPTION").size();m=a(d)[0].selectedIndex;for(i=a(d)[0].selectedIndex-i;a(d).find("OPTION").eq(i).attr("disabled")===!0&&i>=0;)i--;i<0&&(i=a(d).find("OPTION:not([disabled]):first").index());a(d)[0].selectedIndex=i;if(a(d)[0].selectedIndex===-1)i=0,a(d)[0].selectedIndex=i;b=a(d).find("OPTION:selected").text();b===""&&(b="\u00a0");a(k).find(".ui-selectBox-label").text(b);i!==m&&a(d).trigger("change");
return!1}d=a(m).find(".ui-selectBox-option");g=-1;a.each(d,function(b,c){a(c).hasClass("ui-selectBox-current")&&(g=b)});g-=i;g<0&&(g=0);a(d).removeClass("ui-selectBox-current");a(d).eq(g).addClass("ui-selectBox-current");j();return!1;case 40:case 39:case 34:i=b.keyCode===34?20:1;if(a(m).size()===0){if(b.altKey)return c(b),!1;b=a(d).find("OPTION").size();m=a(d)[0].selectedIndex;for(i=a(d)[0].selectedIndex+i;a(d).find("OPTION").eq(i).attr("disabled")===!0&&i<=a(d).find("OPTION").size();)i++;i>b-1&&
(i=a(d).find("OPTION:not([disabled]):last").index());a(d)[0].selectedIndex=i;if(a(d)[0].selectedIndex===-1)i=a(d).find("OPTION").size()-1,a(d)[0].selectedIndex=i;b=a(d).find("OPTION:selected").text();b===""&&(b="\u00a0");a(k).find(".ui-selectBox-label").text(b);i!=m&&a(d).trigger("change");return!1}d=a(m).find(".ui-selectBox-option");g=-1;a.each(d,function(b,c){a(c).hasClass("ui-selectBox-current")&&(g=b)});g+=i;g>a(d).size()-1&&(g=a(d).size()-1);a(d).removeClass("ui-selectBox-current");a(d).eq(g).addClass("ui-selectBox-current");
j();return!1;case 36:case 35:if(a(m).size()===0){if(b.altKey)return c(b),!1;m=a(d)[0].selectedIndex;i=b.keyCode===36?0:a(d).find("OPTION").size()-1;a(d).find("OPTION").eq(i).attr("disabled")===!0&&(i=b.keyCode===36?a(d).find("OPTION:not([disabled]):first").index():a(d).find("OPTION:not([disabled]):last").index());a(d)[0].selectedIndex=i;b=a(d).find("OPTION:selected").text();b===""&&(b="\u00a0");a(k).find(".ui-selectBox-label").text(b);i!=m&&a(d).trigger("change");return!1}a(m).find(".ui-selectBox-current").removeClass("ui-selectBox-current");
...
"select"||a(e).attr("multiple")===!0||(a(e).attr("disabled")===!0&&a(k).addClass("ui-selectBox-disabled"),b=a(e).find("OPTION:selected").text(),b===""&&(b="\u00a0"),a(k).append('<span class="ui-selectBox-label">'+o(b)+"</span>"),a(k).append('<span class="ui-selectBox-arrow"></span>'),a(e).hide().after(k),n(k),a(k).bind("click",function(){return!1}).bind("mousedown",{select:e,control:k},c).bind("focus",{select:e,control:k},g).bind("blur",{select:e,control:k},h))}}),a(this)}}})}(jQuery);
CanvasRenderingContext2D.prototype.dashedLineTo=function(a,d,b,c,e){var f=function(a,b){return a<=b},g=function(a,b){return a>=b},h=function(a,b){return Math.min(a,b)},i=function(a,b){return Math.max(a,b)},j={thereYet:g,cap:h};g={thereYet:g,cap:h};if(d-c>0)g.thereYet=f,g.cap=i;if(a-b>0)j.thereYet=f,j.cap=i;this.moveTo(a,d);f=a;i=d;h=0;for(var n=!0;!j.thereYet(f,b)||!g.thereYet(i,c);){var o=Math.atan2(c-d,b-a),l=e[h];f=j.cap(b,f+Math.cos(o)*l);i=g.cap(c,i+Math.sin(o)*l);n?this.lineTo(f,i):this.moveTo(f,
i);h=(h+1)%e.length;n=!n}};CanvasRenderingContext2D.prototype.dottedArc=function(a,d,b,c,e,f){var g=Math.PI/b/2,h=c;for(c+=g;c<e;)this.beginPath(),this.arc(a,d,b,h,c,f),this.stroke(),h=c+g,c=h+g};
...
new a.simplification.Line(d[0],d[d.length-1]),f=0,g=0,h=1;h<=d.length-2;h++){var i=e.distanceToPoint(d[h]);i>f&&(f=i,g=h)}f>=b?(f=d[g],e.distanceToPoint(f,!0),c=c.concat(a.simplification.douglasPeucker(d.slice(0,g+1),b)),c=c.concat(a.simplification.douglasPeucker(d.slice(g,d.length),b))):(f=d[g],e.distanceToPoint(f,!0),c=[d[0]]);return c},simplifyPath:function(d,b){var c=[];c.push(d.shift());c=c.concat(a.simplification.douglasPeucker(d.slice(0,-1),b));c.push(d[d.length-2]);c.push(d[d.length-1]);return c},
weightPath:function(d,b){for(var c=b.length+1,e=d;tolerance=b.shift();){e=a.simplification.douglasPeucker(e,tolerance);for(var f=0;f<e.length;f++)e[f].significance++}d[0].significance=c;d[d.length-1].significance=c;return d}};return a}(Mark||{});
Mark=function(a){a.dof=1E4;a.thickMarkBrush=function(d,b,c,e,f,g){e=e?e:"0,0,0";var h=Mark.renderer.translatePoint(b[0][0],c),i={minX:h.x,maxX:h.x,minY:h.y,maxY:h.y};if(!f||!g||!(h.x>f*2||h.x<-f||h.y>g*2||h.y<-g||h.z>a.dof||h.z<0)){for(f=0;f<b.length;f++)if(!(typeof b[f]=="undefined"||b[f].length<=1))for(var j=null,n=0;n<b[f].length;n++)if(h=Mark.renderer.translatePoint(b[f][n],c),!(h.z&&h.z>a.dof)&&!(h.significance&&h.significance*(a.dof/5)<h.z-500))if(j){d.lineWidth=1;if(n==b[f].length-1)var o=
0,l=0;else l=9-Math.max(0,Math.pow(h.speed+1,3)),c.mode=="flatScale"&&c.scale.thickness?l*=c.scale.thickness:h.z&&(l*=2/h.z*(g/2)),l<0.1&&(l=0.1),l+=1,o=Math.cos(h.angle)*l,l*=Math.sin(h.angle);d.strokeStyle="rgba("+e+","+(a.dof-h.z)/a.dof+")";d.fillStyle="rgba("+e+","+(a.dof-h.z)/a.dof+")";try{d.beginPath(),d.lineWidth=0.5*((a.dof-h.z)/a.dof),d.moveTo(j.x-prevPX-0.5,j.y-prevPY-0.5),d.lineTo(j.x+prevPX-0.5,j.y+prevPY-0.5),d.lineTo(h.x+o-0.5,h.y+l-0.5),d.lineTo(h.x-o-0.5,h.y-l-0.5),d.lineTo(j.x-prevPX-
0.5,j.y-prevPY-0.5),d.fill(),d.stroke()}catch(p){}i.minX=h.x<i.minX?h.x:i.minX;i.minY=h.y<i.minY?h.y:i.minY;i.maxX=h.x>i.maxX?h.x:i.maxX;i.maxY=h.y>i.maxY?h.y:i.maxY;j=h;prevPX=o;prevPY=l}else{if(f!=0&&h.z<1500&&(j=Mark.renderer.translatePoint(b[f-1][b[f-1].length-1],c),j.z&&j.z<a.dof))d.strokeStyle="rgba(0,0,0,0.3)",d.lineWidth=1,d.beginPath(),d.dashedLineTo(j.x,j.y,h.x,h.y,[6,4]),d.closePath(),d.stroke();j=h;prevPY=prevPX=0}return i}};a.connectionBrush=function(d,b,c,e,f,g,h){e={offset:e,w:g,h:h,
mode:"pinhole"};b=Mark.renderer.translatePoint(b,e);e.offset=f;c=Mark.renderer.translatePoint(c,e);if(!(b.x>g||b.x<0||b.y>h||b.y<0)||!(c.x>g||c.x<0||c.y>h||c.y<0))if(!b.z||!c.z||!(b.z>a.dof||b.z<0)||!(c.z>a.dof||c.z<0))d.strokeStyle="rgba(0,0,0,"+(a.dof-b.z)/(a.dof*2)+")",f=3*(2/b.z)*(h/2),f<1&&(f=1),d.lineWidth=f,d.beginPath(),d.dashedLineTo(b.x,b.y,c.x,c.y,[6,4]),d.closePath(),d.stroke()};a.thickBrush=function(a,b,c,e,f){c=c?c:0;e=e?e:0;f=f?f:1;for(var g=0;g<b.length;g++)if(!(typeof b[g]=="undefined"||
...
a.moveTo(j-h-0.5+c,n-i-0.5+e),a.lineTo(j+h-0.5+c,n+i-0.5+e),a.lineTo(l.x+p-0.5+c,l.y+k-0.5+e),a.lineTo(l.x-p-0.5+c,l.y-k-0.5+e),a.lineTo(j-h-0.5+c,n-i-0.5+e),a.fill(),a.stroke()}catch(m){}h=p;i=k;j=l.x;n=l.y;prevAng=l.angle}}}};a.circleMarkBrush=function(d,b,c){for(var e=3,f=0;f<b.length;f++)if(b[f].length!=0)for(var g=0;g<b[f].length;g++){var h=Mark.renderer.translatePoint(b[f][g],c);if(!(h.z&&h.z>a.dof))e=3*((a.dof-h.z)/a.dof),d.fillStyle="rgba(255,255,255,0.4)",d.strokeStyle="rgba(255,255,255,0.4)",
...
d.camera.position.z};var i={x:d.objects[f].position.x-d.camera.position.x,y:d.objects[f].position.y-d.camera.position.y,z:d.objects[f].position.z-d.camera.position.z},j=d.objects[f+1].leftmostStrokeStart(),n=d.objects[f].rightmostStrokeEnd();Mark.connectionBrush(d.canvasContext,j,n,h,i,c,e)}h={offset:g,w:b.width,h:b.height,mode:"pinhole"};if(d.objects[f].reference in d.timers){if((g=a.renderer.strokesAtTime(d.objects[f].strokes,((new Date).getTime()-d.timers[d.objects[f].reference].start)*d.timers[d.objects[f].reference].speed))&&
