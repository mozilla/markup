...
Mark.renderer.renderMark(b.layerManager.layers.mainMark.context,b.xMark,{offset:{x:10,y:-400},scale:{x:a.width/2/b.xMark.bWidth,y:(a.height+800)/b.xMark.bHeight,thickness:6},color:"0,0,0",timer:b.textScene.timers[b.xMark.reference]})}},ready:function(d){a("#markmaker").hide().children().hide();a.when(modules.intro.fn.initInterface(d),modules.intro.fn.loadMarks(d)).then(function(){modules.intro.fn.runVizPreview(d)}).then(function(){modules.intro.fn.startDomAnimation(d)}).fail(function(){modules.intro.fn.simpleIntro(d)})}},
...
(c=!0,a("#markmaker, #browse-marks, #click-anywhere, #intro-main-copy").css({display:"block"}));a("#browse-marks").css({top:d-50,left:b-85});a("#click-anywhere").css({top:d+12,left:b-a("#intro-main-copy").width()});a("#intro-main-copy").css({top:d-a("#intro-main-copy").height()-100,left:b-a("#intro-main-copy").width()});c&&a("#markmaker, #browse-marks, #click-anywhere, #intro-main-copy").css({display:"none"})}).trigger("resize.markApp",[d.width,d.height]).width(0).height(d.height)},loadMarks:function(d){d.fn.showLoader(d.fn.getString("loading-intro-msg"),
...
3E3)},startMarkAnimations:function(a){var b=a.modules.intro;modules.intro.fn.drawX(a);b.curLocaleMark&&(a=(new Date).getTime()+2E3,b.textScene.timers[b.curLocaleMark.reference]={start:a,end:a+b.curLocaleMark.maxTime,speed:2})},drawX:function(a){a=a.modules.intro;a.xMark=new Mark.gmlMark({strokes:[[{x:177,y:0,z:0,time:51,speed:0,angle:0,significance:5},{x:129,y:60,z:0,time:255,speed:0.45069390943299864,angle:0.5880026035475675,significance:1},{x:123,y:65,z:0,time:271,speed:0.4931203163041915,angle:0.7853981633974483,
significance:1},{x:103,y:89,z:0,time:339,speed:0.45069390943299864,angle:0.5880026035475675,significance:1},{x:56,y:139,z:0,time:503,speed:0.45073896963561083,angle:0.7853981633974483,significance:1},{x:38,y:162,z:0,time:584,speed:0.3572203090978693,angle:0.46364760900080615,significance:1},{x:9,y:192,z:0,time:691,speed:0.3535533905932738,angle:0.7853981633974483,significance:1},{x:0,y:206,z:0,time:727,speed:0.45069390943299864,angle:0.5880026035475675,significance:5}],[{x:11,y:23,z:0,time:1178,speed:0,
angle:0,significance:5},{x:30,y:49,z:0,time:1246,speed:0.32424352695503,angle:5.639684198386302,significance:1},{x:55,y:77,z:0,time:1321,speed:0.48790367901871773,angle:5.497787143782138,significance:1},{x:72,y:100,z:0,time:1367,speed:0.5216642390945547,angle:5.695182703632019,significance:1},{x:85,y:113,z:0,time:1408,speed:0.5355917833779965,angle:5.497787143782138,significance:2},{x:154,y:175,z:0,time:1662,speed:0.3311927108182759,angle:5.497787143782138,significance:1},{x:186,y:196,z:0,time:1802,
speed:0.2849548128987055,angle:5.497787143782138,significance:5}]],country_code:"",time:1300925747439,rtl:!1,maxTime:1802,reference:"",hoverState:!1,renderedBounds:null,id:null,contributor_name:null,extra_info:null,color:"0,0,0",hoverColor:"0,139,211",x:454,y:199,position:{x:0,y:0,z:0},rotationAngle:{x:0,y:0,z:0},sX:0,sY:0,bWidth:186,bHeight:206}.strokes,"xMark");a.textScene.objects.push(a.xMark);var b=(new Date).getTime();a.textScene.timers[a.xMark.reference]={start:b,end:b+a.xMark.maxTime,speed:1}},
simpleIntro:function(d){a("#markmaker").width(0).show().animate({width:d.width},"slow",function(){a("#intro-main-copy").fadeIn("slow");a("#click-anywhere").delay(200).fadeIn("slow");a("#browse-marks").delay(100).fadeIn("slow")})}}}})(jQuery);
