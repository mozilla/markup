...
0){a("#markapp").markApp("unloadModule","intro");a("#markapp").markApp("addModule",{capture:e})}else this.partial("makemark_sammy.html").then(function(){a("body").addClass("make-your-mark");a("#markapp").markApp("addModule",{capture:e});a("#sammy").css("zIndex","")})});this.get("#/moderate",function(){a("#markapp").markApp("unloadModule","intro");a("#markapp").markApp("unloadModule","capture");this.partial("moderate_sammy.html").then(function(){a("#markapp").markApp("addModule",{linear:{is_flagged:true,
linear_root:"moderate"}})})});this.get("#/moderate/(.*)",function(b){a("#markapp").markApp("unloadModule","intro");a("#markapp").markApp("unloadModule","capture");a("#linear").size()>0?a("#markapp").markApp("addModule",{linear:{is_flagged:true,linear_root:"moderate",reference_mark:b.params.splat[0],playback:b.params.playback}}):this.partial("moderate_sammy.html").then(function(){a("#sammy").css("zIndex","");a("#markapp").css({zIndex:100,cursor:"default"});a("#markapp").markApp("addModule",{linear:{is_flagged:true,
