...
a.modules.capture;c.layerManager.layers.liveDrawingLayer.clean();if(a.mouseIn&&(c.state=="drawing"||c.state=="intro"))d.capture.fn.drawCursor(c.layerManager.layers.liveDrawingLayer.context,a.mouseX,a.mouseY,(c.captureLimit-c.capturedPoints)/c.captureLimit),a.$cursorTooltip&&a.$cursorTooltip.css({top:a.mouseY-a.$cursorTooltip.height()-32,left:a.mouseX+8})},introLoop:function(){},drawLoop:function(b){var c=b.modules.capture;if(c.currentStroke&&c.currentStroke.length>0)Mark.thickBrush(c.layerManager.layers.liveDrawingLayer.context,
