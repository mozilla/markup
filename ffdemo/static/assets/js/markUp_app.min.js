...
"markapp-loader").append(a("<div />").text(d));e&&j.append(a("<p />").html(e));i&&typeof i==="number"?b.loaderTimeout=setTimeout(function(){b.$container.append(j);j.fadeIn("fast")},i):(b.$container.append(j),j.fadeIn("fast"))},hideLoader:function(){clearTimeout(b.loaderTimeout);a("#markapp-loader").fadeOut("fast",function(){a(this).remove()})},showError:function(d,c){d=typeof d==="string"?d:b.fn.getString("default-error-msg");b.fn.hideError();b.fn.hideLoader();var e=a("<div />").width(b.width).height(b.height).hide().click(function(a){a.preventDefault();
b.fn.hideError();c&&typeof c==="string"&&b.app.setLocation(c)}).addClass("overlay-wrapper autoResize").attr("id","markapp-error").append(a("<div />").attr("id","markapp-error-content").append(a("<p />").html(d)));b.$container.append(e);e.fadeIn("fast")},hideError:function(){a("#markapp-error").fadeOut("fast",function(){a(this).remove()})},loadTranslations:function(){a("div.translated-strings").each(function(){a(this).children().each(function(){var d=a(this);d.is("ol")?(b.translatedStrings[d.attr("id")]=
[],d.children().each(function(){b.translatedStrings[d.attr("id")].push(a(this).html())})):b.translatedStrings[d.attr("id")]=d.html()})})},getString:function(a,d){return a in b.translatedStrings?typeof b.translatedStrings[a]==="object"&&typeof d==="number"?b.translatedStrings[a][d]:b.translatedStrings[a]:a},storeData:function(a,b){if(typeof localStorage!="undefined")try{typeof b==="object"&&(b=JSON.stringify(b)),localStorage.setItem(a,b)}catch(d){}},getData:function(a){if(typeof localStorage!="undefined")return(a=
...
"#/"+b.linear_root+"/country/"+b.country_code+"/"+c.country_last_mark)):(a("#first-mark-link").attr("href","#/"+b.linear_root+"/"+c.first_mark),a("#last-mark-link").attr("href","#/"+b.linear_root+"/"+c.last_mark));a("#mark-browsing").collapsibleMod();a("#total-mark-count").text(c.max_id);if(a("#contributor-select option").size()==1){var g=a("#contributor-select");if(c.contributor_marks)for(var h=0;h<c.contributor_marks.length;h++){var i=a("<option />").val(c.contributor_marks[h].reference).text(c.contributor_marks[h].contributor);
g.append(i)}g.change(function(){var c=a(this).val();c!="label"&&d.app.setLocation("#/"+b.linear_root+"/"+c);a(this).blur();d.$container.focus()});b.country_code?(e.country_code=b.country_code,a("#contributor-select").next().hide(),a("#contributor-select-label").hide()):(a("#contributor-select").next().show(),a("#contributor-select-label").show())}}})},dumpAllMarks:function(a){a=a.modules.linear;for(mark in a.marks)delete a.marks[mark];a.scene.objects=[];a.leftBuffer=[];a.rightBuffer=[];a.moreRight=
...
return!1},showMarkInformation:function(d){var b=d.modules.linear;if(!b.currentMark)return!1;var c=b.currentMark;a("#mark-id").text(c.id);var e=new Date(c.time);e=new Date(e.getTime()+36E5*d.timezoneOffset);var f=[];f.push(e.getHours()+":"+(String(e.getMinutes()).length==1?"0"+e.getMinutes():e.getMinutes()));f.push("GMT");f.push(d.fn.getString("month-abbreviations",e.getMonth())+" "+e.getDate()+", "+e.getFullYear());c.country_code?d.fn.withCountryCodes(function(b){c.country_code in b?a("#mark-country").text(" / "+
b[c.country_code]):a("#mark-country").text("")}):a("#mark-country").text("");c.contributor_name?(a("#mark-contributor-name").text(c.contributor_name),a("#contributor-name").text(c.contributor_name),a("#mark-flag").hide(),"extra_info"in c&&c.extra_info!=null&&c.extra_info!=""&&a("#contributor-quote").text("\u201c"+c.extra_info+"\u201d"),"contributor_url"in c&&d.fn.validate.url(c.contributor_url)?a("#mark-contributor-url").text(c.contributor_url.replace(/(ftp|http|https):\/\//,"").replace(/\/$/,"")).attr("href",
c.contributor_url):a("#mark-contributor-url").text("").attr("href",""),a("#contributor-information").show()):(a("#mark-contributor-name, #contributor-quote, #contributor-name, #mark-contributor-url").text(""),a("#contributor-information").hide(),a("#mark-flag").show());a("#mark-timestamp").text(f.join(" "));a("#url-share input").val(window.location.href);if(b.linear_root!="moderate")a("#twitter-share").data("socialShare-context").share_params.url=window.location.href,a("#facebook-share").data("socialShare-context").share_params.u=
window.location.href;b.linear_root=="moderate"&&a("#approve-mark-checkbox").attr("checked",c.is_approved);b.currentMark.reference in b.flaggings?a("#mark-flag").addClass("disabled"):a("#mark-flag").removeClass("disabled");a("#mark-information").fadeIn("fast")},resetMarkInformation:function(){a("#mark-information").find("a").attr("href","#").end().find("#mark-id, #total-mark-count, #mark-timestamp, #mark-country")},hideMarkInformation:function(){a("#mark-information").fadeOut("fast")},replayCurrentMark:function(a){a=
a.modules.linear;var b=(new Date).getTime();a.eventChange=!0;a.scene.timers[a.currentMark.reference]={start:b,end:b+a.currentMark.maxTime,speed:1}},downloadCurrentMark:function(a){a=a.modules.linear;a.currentMark&&a.currentMark.reference&&window.open("/gml/"+a.currentMark.reference)},flagCurrentMark:function(d){var b=d.modules.linear;b.currentMark.reference in b.flaggings||a.ajax({url:"/requests/flag_mark",data:{reference:b.currentMark.reference},type:"POST",dataType:"JSON",success:function(){a("#mark-flag").addClass("disabled");
b.flaggings[b.currentMark.reference]=!0;d.fn.storeData("markFlaggings",b.flaggings)},error:function(){d.fn.showError(d.fn.getString("error-msg"),"#/linear/")}})},deleteCurrentMark:function(d){var b=d.modules.linear;a.ajax({url:"/requests/delete_mark",data:{reference:b.currentMark.reference},type:"POST",dataType:"JSON",success:function(){var a=b.currentMark.reference,e=null;delete b.marks[b.currentMark.reference];b.currentMark=null;for(var f=0;f<b.scene.objects.length;f++)if(e||b.scene.objects[f].reference==
a){if(!e)e=f,b.scene.objects.splice(f,1),b.currentMark=b.scene.objects[f];f==0?b.scene.objects[f].positionToStart():b.scene.objects[f].positionRelativeTo(b.scene.objects[f-1])}d.app.setLocation("#/"+b.linear_root+"/"+b.currentMark.reference);b.eventChange=!0},error:function(){d.fn.showError(d.fn.getString("error-msg"),"#/linear/")}})},approveCurrentMark:function(d,b){var c=d.modules.linear;a.ajax({url:"/requests/approve_mark",data:{reference:c.currentMark.reference,should_approve:b},type:"POST",dataType:"JSON",
success:function(){c.currentMark.is_approved=b},error:function(){d.fn.showError(d.fn.getString("error-msg"),"#/linear/")}})},centerCurrentMark:function(a,b){var c=a.modules.linear;if(!c.currentMark)return!1;modules.linear.fn.showMarkInformation(a);c.cameraChange.aX=0;c.cameraChange.vX=0;c.cameraChange.aZ=0;c.cameraChange.vZ=0;var e=Math.abs(c.currentMark.position.x-c.scene.camera.position.x)/2;e=Math.max(1E3,e);var f="cameraEase"in c.tweens?c.tweens.cameraEase:new TWEEN.Tween(c.scene.camera.position);
f.to({x:c.currentMark.position.x+c.currentMark.bWidth/2,y:c.currentMark.position.y+c.currentMark.bHeight/2,z:c.currentMark.position.z-1E3},e).onComplete(function(){delete c.tweens.cameraEase;typeof b==="function"&&b(this)}).easing(e>1200?TWEEN.Easing.Quadratic.EaseInOut:TWEEN.Easing.Quartic.EaseInOut).start();c.tweens.cameraEase=f}}}})(jQuery);
...
function(a){a.preventDefault();d.capture.fn.reset(b)});a("#markmaker-submit a").addClass("disabled").bind("mousedown",function(a){a.preventDefault();d.capture.fn.submit(b)});b.fn.withCountryCodes(function(b){for(var c=a("#markmaker-country"),d=0;d<b.length;d++){var h=a("<option />").val(b[d].code).text(b[d].name);c.append(h)}});a("#markmaker-location a").bind("mousedown",{context:b},d.capture.fn.locationDialogToggle);a("#markmaker-information").bind("mouseover",{context:b},d.capture.fn.informationDialogToggle).bind("mouseout",
{context:b},d.capture.fn.informationDialogToggle);c.state=="drawing"&&d.capture.fn.initDrawing(b);a("#sammy #markmaker-country").selectBox({autoWidth:!1})},loop:function(a){var c=a.modules.capture;if(c.initialized)switch(c.frameCount++,d.capture.fn.commonLoop(a),a.modules.capture.state){case "drawing":d.capture.fn.drawLoop(a)}}},fn:{init:function(b,c){var e=b.modules.capture;if("$capture"in e){if("state"in c)d.capture.fn.reset(b),c.state=="drawing"&&b.mouseDown&&b.fn.trigger("mousedown"),e.state=
c.state,d.capture.fn.initDrawing(b)}else a.extend(e,d.capture.defaults),a.extend(e,c),a.extend(e,d.capture.config),e.$capture=a("<div />").addClass("capture-container"),b.$container.css({zIndex:100,cursor:"none"}).append(e.$capture),e.layerManager=new Mark.layerManager(e.$capture.get(0)),e.layerManager.addLayer("drawnLayer"),e.layerManager.addLayer("liveDrawingLayer"),b.fn.trigger("resize"),e.initialized=!0},deinit:function(a){var c=a.modules.capture;c.$capture.fadeOut("fast",function(){c.layerManager.removeAll();
...
a("#information-dialog").fadeIn("fast").css({bottom:a("#markmaker-information").height()+36,left:a("#markmaker-information").offset().left-a("#information-dialog").width()+30})},startMark:function(b){var c=b.modules.capture;c.captureTime=(new Date).getTime();c.rtl=b.mouseX>a(window).width()/2;c.mark=new Mark.gmlMark([],"","",c.captureTime,c.rtl);a("#markmaker-submit a, #markmaker-reset a").removeClass("disabled")},endMark:function(a){a.modules.capture.mark.setupVars()},startStroke:function(a){a=a.modules.capture;
a.currentStroke=[];if(a.strokes.length>0)a.captureTime=(new Date).getTime()-(a.strokes[a.strokes.length-1][a.strokes[a.strokes.length-1].length-1].time+a.timeBetweenStrokes)},endStroke:function(a){var c=a.modules.capture;if(c.currentStroke.length>2){c.strokes.push(c.currentStroke);var e=Mark.simplification.simplifyPath(c.currentStroke,1);e=Mark.simplification.weightPath(e,[5,10,20,40]);c.mark.strokes.push(e);c.cleanedStrokes.push(e);d.capture.fn.drawStroke(a,e);c.capturedPoints-=c.currentStroke.length-
e.length}c.currentStroke=null},capturePoint:function(a){var c=a.modules.capture;if(c.capturedPoints>c.captureLimit)a.fn.trigger("mouseup"),d.capture.fn.closeShop(a);else{var e=(new Date).getTime();a=new Mark.gmlPoint(a.mouseX,a.mouseY,e-c.captureTime,0);c.currentStroke.length>0?(e=c.currentStroke[c.currentStroke.length-1],a.speed=e.speedToPoint(a),a.setAngleFromPoint(e),a.smoothAgainst(e,0.01)):c.strokes.length>=1&&d.capture.fn.drawGuide(c.layerManager.layers.drawnLayer.context,c.lastX,c.lastY,a.x,
a.y);c.currentStroke.push(a);c.lastX=a.x;c.lastY=a.y;c.capturedPoints++}},reset:function(b){b=b.modules.capture;b.layerManager.layers.liveDrawingLayer.clean();b.layerManager.layers.drawnLayer.clean();b.capturedPoints=0;b.rtl=null;b.mouseDown=!1;b.lastX=null;b.lastY=null;b.strokes=[];b.currentStroke=null;b.mark=null;b.captureTime=null;b.state="drawing";a("#markmaker-submit a, #markmaker-reset a").addClass("disabled");a("#markapp").css({cursor:"none"});a("#markmaker-instructions").fadeIn()},closeShop:function(b){var c=
b.modules.capture;c.state="preview";d.capture.fn.endMark(b);c.layerManager.layers.liveDrawingLayer.clean();b=c.layerManager.layers.liveDrawingLayer.context;var e=c.lastX,f=c.lastY;b.strokeStyle="rgba(0,0,0,0.2)";b.lineWidth=1;b.beginPath();b.dashedLineTo(e,f,c.rtl?0:c.layerManager.layers.liveDrawingLayer.canvas.width,f,[7,5]);b.closePath();b.stroke();a("#markapp").css({cursor:"default"})},submit:function(b){var c=b.modules.capture;if(c.state!="submitting"){c.state!="preview"&&d.capture.fn.closeShop(b);
c.state="submitting";a("#markmaker-submit a").addClass("disabled");var e={};e.rtl=c.rtl;e.strokes=c.strokes;e=JSON.stringify(e);var f=JSON.stringify(c.mark),g=a("#markmaker-country").val()=="label"?"":a("#markmaker-country").val();b.fn.showLoader(b.fn.getString("submitting-mark"));var h={points_obj:e,points_obj_simplified:f,country_code:g};if(c.invite_code&&c.contributor_type=="t")h.contributor_locale=b.locale,h.invite=c.invite_code;else if(c.invite_code&&c.contributor_type=="c")h.contributor=a("#contributor-name").val(),
c.mark.extra_info=a("#contributor-quote").val(),c.mark.contributor_url=a("#contributor-url").val(),h.points_obj_simplified=JSON.stringify(c.mark),h.invite=c.invite_code;a.ajax({url:"/requests/save_mark",data:h,type:"POST",dataType:"JSON",success:function(a){h.contributor_locale?b.app.setLocation("#/linear/"):(b.fn.storeData("userMark",{reference:a.mark_reference,country_code:g}),b.app.setLocation("#/linear/"+a.mark_reference+"?playback=true&be_grateful=true"));b.fn.hideLoader()},error:function(){b.fn.showError(b.fn.getString("submit-error"))}});
return!1}},drawStroke:function(a,c){var d=a.modules.capture;Mark.thickBrush(d.layerManager.layers.drawnLayer.context,[c]);d.layerManager.layers.drawnLayer.context.fillStyle="rgba(255,255,255,0.3)";d.layerManager.layers.drawnLayer.context.strokeStyle="rgba(255,255,255,0.3)";Mark.circleBrush(d.layerManager.layers.drawnLayer.context,[c])},drawGuide:function(a,c,d,f,g){a.strokeStyle="rgba(0,0,0,0.2)";a.lineWidth=1;a.beginPath();a.dashedLineTo(c,d,f,g,[7,5]);a.closePath();a.stroke()},drawCursor:function(a,
c,d,f){a.strokeStyle="#ff5400";a.fillStyle="#000000";a.beginPath();a.moveTo(c,d);a.lineTo(c+1,d-8);a.lineTo(c+20,d-27);a.lineTo(c+23,d-23);a.lineTo(c,d);a.closePath();a.stroke();f*=18.5;f+=4.5;a.beginPath();a.moveTo(c,d);a.lineTo(c+1,d-8);a.lineTo(c+(f-3),d-(f+4));a.lineTo(c+f,d-f);a.lineTo(c,d);a.closePath();a.fill()},commonLoop:function(a){var c=a.modules.capture;c.layerManager.layers.liveDrawingLayer.clean();a.mouseIn&&(c.state=="drawing"||c.state=="intro")?(d.capture.fn.drawCursor(c.layerManager.layers.liveDrawingLayer.context,
a.mouseX,a.mouseY,(c.captureLimit-c.capturedPoints)/c.captureLimit),a.$cursorTooltip&&a.$cursorTooltip.fadeIn().css({top:a.mouseY-a.$cursorTooltip.height()-20,left:a.mouseX-12})):a.mouseIn||a.$cursorTooltip&&a.$cursorTooltip.fadeOut()},introLoop:function(){},drawLoop:function(b){var c=b.modules.capture;if(c.currentStroke&&c.currentStroke.length>0)Mark.thickBrush(c.layerManager.layers.liveDrawingLayer.context,[c.currentStroke]),c.layerManager.layers.liveDrawingLayer.context.fillStyle="rgba(255,255,255,0.3)",
c.layerManager.layers.liveDrawingLayer.context.strokeStyle="rgba(255,255,255,0.3)",Mark.circleBrush(c.layerManager.layers.liveDrawingLayer.context,[c.currentStroke]);if(b.mouseIn&&!b.mouseDown){var e,f;c.strokes.length==0?(e=b.mouseX>a(window).width()/2?c.layerManager.layers.liveDrawingLayer.canvas.width:0,f=b.mouseY):(e=c.lastX,f=c.lastY);d.capture.fn.drawGuide(c.layerManager.layers.liveDrawingLayer.context,e,f,b.mouseX,b.mouseY)}}}}})(jQuery);
...
b[f].date_drawn,g.rtl,b[f].id,b[f].is_approved);if(!c.currentMark)c.currentMark=h;b[f].reference in c.marks||(c.marks[h.reference]=h);e&&h.positionRelativeTo(e,!1);if(b[f].contributor_locale==d.locale||!c.curLocaleMark){var i=(new Date).getTime()*3;c.curLocaleMark=new Mark.gmlMark(g.strokes,b[f].reference,b[f].country_code,b[f].date_drawn,g.rtl,b[f].id,b[f].is_approved);c.textScene.timers[c.curLocaleMark.reference]={start:i,end:i+c.curLocaleMark.maxTime,speed:2}}c.vizScene.objects.push(h);e=h}catch(j){}}},
