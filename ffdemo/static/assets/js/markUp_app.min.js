...
function(a){return b.fn.trigger(a.type,a)}),b.fn.loop();var c=a.makeArray(arguments);if(c.length>0){var e=c.shift();if(e in b.public_fn)b.public_fn[e](b,typeof c[0]=="undefined"?{}:c[0])}return d.data("markApp-context",b)}})(jQuery);
...
0)for(var e=0;e<c.mark.strokes.length;e++)d.capture.fn.drawStroke(a,c.mark.strokes[e])},mousemove:function(a){a.mouseDown&&a.modules.capture.state=="drawing"&&d.capture.fn.capturePoint(a)},mousedown:function(b){switch(b.modules.capture.state){case "drawing":a("#markmaker-controls, #contributor-fields, #translator-fields, #markmaker-legal-line").css("zIndex",0);a("#location-dialog").is(":visible")&&a("#location-dialog").fadeOut("fast");b.modules.capture.mark||d.capture.fn.startMark(b);b.modules.capture.currentStroke||
d.capture.fn.startStroke(b);break;case "intro":b.modules.capture.mark||d.capture.fn.startMark(b),b.modules.capture.currentStroke||d.capture.fn.startStroke(b),d.capture.fn.endIntro(b)}},mouseup:function(b){b.modules.capture.state=="drawing"&&(d.capture.fn.endStroke(b),a("#markmaker-controls, #contributor-fields, #translator-fields, #markmaker-legal-line").css("zIndex",200))},ready:function(b){var c=b.modules.capture;a("#markmaker").hide().children().hide();a("#markmaker-reset a").addClass("disabled").bind("mousedown",
function(a){a.preventDefault();d.capture.fn.reset(b)});a("#markmaker-submit a").addClass("disabled").bind("mousedown",function(c){c.preventDefault();a(this).is(":not(.disabled)")&&d.capture.fn.submit(b)});b.fn.withCountryCodes(function(b){for(var c=a("#markmaker-country"),d=0;d<b.length;d++){var h=a("<option />").val(b[d].code).text(b[d].name);c.append(h)}});a("#markmaker-location a").bind("mousedown",{context:b},d.capture.fn.locationDialogToggle);a("#markmaker-information").bind("mouseover",{context:b},
d.capture.fn.informationDialogToggle).bind("mouseout",{context:b},d.capture.fn.informationDialogToggle);c.state=="drawing"&&d.capture.fn.initDrawing(b);a("#sammy #markmaker-country").selectBox({autoWidth:!1})},loop:function(a){var c=a.modules.capture;if(c.initialized)switch(c.frameCount++,d.capture.fn.commonLoop(a),a.modules.capture.state){case "drawing":d.capture.fn.drawLoop(a)}}},fn:{init:function(b,c){var e=b.modules.capture;if("$capture"in e){if("state"in c)d.capture.fn.reset(b),c.state=="drawing"&&
b.mouseDown&&b.fn.trigger("mousedown"),e.state=c.state,d.capture.fn.initDrawing(b)}else a.extend(e,d.capture.defaults),a.extend(e,c),a.extend(e,d.capture.config),e.$capture=a("<div />").addClass("capture-container"),b.$container.css({zIndex:100,cursor:"none"}).append(e.$capture),e.layerManager=new Mark.layerManager(e.$capture.get(0)),e.layerManager.addLayer("drawnLayer"),e.layerManager.addLayer("liveDrawingLayer"),b.fn.trigger("resize"),e.initialized=!0},deinit:function(a){var c=a.modules.capture;
c.$capture.fadeOut("fast",function(){c.layerManager.removeAll();c.$capture.remove();c.initialized=!1})},initIntro:function(){},initDrawing:function(b){var c=b.modules.capture;a("#browse-marks").is(":visible")&&(a("#browse-marks, #click-anywhere, #intro-main-copy, #the-big-x").fadeOut("fast"),a("#markmaker-legal-line").fadeIn("slow"));a("#markmaker").css("background-position","0 "+(b.height-140)+"px");a("#markmaker").unbind("resize.markApp").bind("resize.markApp",function(){a("#markmaker").css("background-position",
...
a("#save-location-button").click(function(b){b.preventDefault();a("#location-dialog").fadeOut();return!1});c.invite_code&&c.contributor_type=="t"?(c.captureLimit=1E3,c.$capture.addClass("translator"),a("#translator-fields").find("#translator-locale").text("'"+b.locale+"'").end().show().collapsibleMod().hide().fadeIn("slow")):c.invite_code&&c.contributor_type=="c"&&(c.$capture.addClass("contributor"),a("#contributor-fields").show().collapsibleMod().hide().fadeIn("slow"));b.$cursorTooltip=b.$cursorTooltip||
...
32})},informationDialogToggle:function(b){b.preventDefault();b.type=="mouseout"?a("#information-dialog").fadeOut("fast"):a("#information-dialog").fadeIn("fast").css({bottom:a("#markmaker-information").height()+36,left:a("#markmaker-information").offset().left-a("#information-dialog").width()+30})},startMark:function(b){var c=b.modules.capture;c.captureTime=(new Date).getTime();c.rtl=b.mouseX>a(window).width()/2;c.mark=new Mark.gmlMark([],"","",c.captureTime,c.rtl)},endMark:function(a){a.modules.capture.mark.setupVars()},
startStroke:function(a){a=a.modules.capture;a.currentStroke=[];if(a.strokes.length>0)a.captureTime=(new Date).getTime()-(a.strokes[a.strokes.length-1][a.strokes[a.strokes.length-1].length-1].time+a.timeBetweenStrokes)},endStroke:function(b){var c=b.modules.capture;if(c.currentStroke.length>=4){if(c.mark.strokes.length==0)a("#markmaker-submit a, #markmaker-reset a").removeClass("disabled");else{var e=c.mark.strokes[c.mark.strokes.length-1];d.capture.fn.drawGuide(c.layerManager.layers.drawnLayer.context,
e[e.length-1].x,e[e.length-1].y,c.currentStroke[0].x,c.currentStroke[0].y)}c.strokes.push(c.currentStroke);e=Mark.simplification.simplifyPath(c.currentStroke,1);e=Mark.simplification.weightPath(e,[5,10,20,40]);c.mark.strokes.push(e);c.cleanedStrokes.push(e);d.capture.fn.drawStroke(b,e);c.capturedPoints-=c.currentStroke.length-e.length}c.currentStroke=null},capturePoint:function(a){var c=a.modules.capture;if(c.capturedPoints>c.captureLimit)a.fn.trigger("mouseup"),d.capture.fn.closeShop(a);else{var e=
(new Date).getTime();a=new Mark.gmlPoint(a.mouseX,a.mouseY,e-c.captureTime,0);if(c.currentStroke.length>0)e=c.currentStroke[c.currentStroke.length-1],a.speed=e.speedToPoint(a),a.setAngleFromPoint(e),a.smoothAgainst(e,0.01);c.currentStroke.push(a);c.lastX=a.x;c.lastY=a.y;c.capturedPoints++}},reset:function(b){b=b.modules.capture;b.layerManager.layers.liveDrawingLayer.clean();b.layerManager.layers.drawnLayer.clean();b.capturedPoints=0;b.rtl=null;b.mouseDown=!1;b.lastX=null;b.lastY=null;b.strokes=[];
b.currentStroke=null;b.mark=null;b.captureTime=null;b.state="drawing";a("#markmaker-submit a, #markmaker-reset a").addClass("disabled");a("#markapp").css({cursor:"none"});a("#markmaker-instructions").fadeIn()},closeShop:function(b){var c=b.modules.capture;c.state="preview";d.capture.fn.endMark(b);c.layerManager.layers.liveDrawingLayer.clean();b=c.layerManager.layers.liveDrawingLayer.context;var e=c.lastX,f=c.lastY;b.strokeStyle="rgba(0,0,0,0.2)";b.lineWidth=1;b.beginPath();b.dashedLineTo(e,f,c.rtl?
0:c.layerManager.layers.liveDrawingLayer.canvas.width,f,[7,5]);b.closePath();b.stroke();a("#markapp").css({cursor:"default"})},submit:function(b){var c=b.modules.capture;if(!(c.state=="submitting"||c.mark==null||c.mark.strokes.length==0)){c.state!="preview"&&d.capture.fn.closeShop(b);c.state="submitting";a("#markmaker-submit a").addClass("disabled");var e={};e.rtl=c.rtl;e.strokes=c.strokes;e=JSON.stringify(e);var f=JSON.stringify(c.mark),g=a("#markmaker-country").val()=="label"?"":a("#markmaker-country").val();
b.fn.showLoader(b.fn.getString("submitting-mark"));var h={points_obj:e,points_obj_simplified:f,country_code:g};if(c.invite_code&&c.contributor_type=="t")h.contributor_locale=b.locale,h.invite=c.invite_code;else if(c.invite_code&&c.contributor_type=="c")h.contributor=a("#contributor-name").val(),c.mark.extra_info=a("#contributor-quote").val(),c.mark.contributor_url=a("#contributor-url").val(),h.points_obj_simplified=JSON.stringify(c.mark),h.invite=c.invite_code;a.ajax({url:"/requests/save_mark",data:h,
type:"POST",dataType:"JSON",success:function(a){h.contributor_locale?b.app.setLocation("#/linear/"):(b.fn.storeData("userMark",{reference:a.mark_reference,country_code:g}),b.app.setLocation("#/linear/"+a.mark_reference+"?playback=true&be_grateful=true"));b.fn.hideLoader()},error:function(){b.fn.showError(b.fn.getString("submit-error"))}});return!1}},drawStroke:function(a,c){var d=a.modules.capture;Mark.thickBrush(d.layerManager.layers.drawnLayer.context,[c]);d.layerManager.layers.drawnLayer.context.fillStyle=
"rgba(255,255,255,0.3)";d.layerManager.layers.drawnLayer.context.strokeStyle="rgba(255,255,255,0.3)";Mark.circleBrush(d.layerManager.layers.drawnLayer.context,[c])},drawGuide:function(a,c,d,f,g){a.strokeStyle="rgba(0,0,0,0.2)";a.lineWidth=1;a.beginPath();a.dashedLineTo(c,d,f,g,[7,5]);a.closePath();a.stroke()},drawCursor:function(a,c,d,f){a.strokeStyle="#ff5400";a.fillStyle="#000000";a.beginPath();a.moveTo(c,d);a.lineTo(c+1,d-8);a.lineTo(c+20,d-27);a.lineTo(c+23,d-23);a.lineTo(c,d);a.closePath();a.stroke();
f*=18.5;f+=4.5;a.beginPath();a.moveTo(c,d);a.lineTo(c+1,d-8);a.lineTo(c+(f-3),d-(f+4));a.lineTo(c+f,d-f);a.lineTo(c,d);a.closePath();a.fill()},commonLoop:function(a){var c=a.modules.capture;c.layerManager.layers.liveDrawingLayer.clean();a.mouseIn&&(c.state=="drawing"||c.state=="intro")?(d.capture.fn.drawCursor(c.layerManager.layers.liveDrawingLayer.context,a.mouseX,a.mouseY,(c.captureLimit-c.capturedPoints)/c.captureLimit),a.$cursorTooltip&&(a.$cursorTooltip.css({top:a.mouseY-a.$cursorTooltip.height()-
32,left:a.mouseX+8}),a.$cursorTooltip.is(":not(:visible)")&&a.$cursorTooltip.stop(!0,!0).fadeIn("fast"))):a.mouseIn||a.$cursorTooltip&&a.$cursorTooltip.stop(!0,!0).fadeOut()},introLoop:function(){},drawLoop:function(b){var c=b.modules.capture;if(c.currentStroke&&c.currentStroke.length>0)Mark.thickBrush(c.layerManager.layers.liveDrawingLayer.context,[c.currentStroke]),c.layerManager.layers.liveDrawingLayer.context.fillStyle="rgba(255,255,255,0.3)",c.layerManager.layers.liveDrawingLayer.context.strokeStyle=
"rgba(255,255,255,0.3)",Mark.circleBrush(c.layerManager.layers.liveDrawingLayer.context,[c.currentStroke]);if(b.mouseIn)if(b.mouseDown)c.mark!=null&&c.currentStroke!=null&&c.mark.strokes.length>0&&c.currentStroke.length>0&&(f=c.mark.strokes[c.mark.strokes.length-1],d.capture.fn.drawGuide(c.layerManager.layers.liveDrawingLayer.context,f[f.length-1].x,f[f.length-1].y,c.currentStroke[0].x,c.currentStroke[0].y));else{var e;if(c.mark==null||c.mark.strokes.length==0)e=b.mouseX>a(window).width()/2?c.layerManager.layers.liveDrawingLayer.canvas.width:
0,f=b.mouseY;else{var f=c.mark.strokes[c.mark.strokes.length-1];e=f[f.length-1].x;f=f[f.length-1].y}d.capture.fn.drawGuide(c.layerManager.layers.liveDrawingLayer.context,e,f,b.mouseX,b.mouseY)}}}}})(jQuery);
...
3E3)},startMarkAnimations:function(d){d=d.modules.intro;a("#the-big-x").fadeIn("slow");if(d.curLocaleMark){var b=(new Date).getTime()+2E3;d.textScene.timers[d.curLocaleMark.reference]={start:b,end:b+d.curLocaleMark.maxTime,speed:2}}},simpleIntro:function(d){var b=d.modules.intro;a("#markmaker").width(0).show().animate({width:d.width},"slow",function(){a("#intro-main-copy").fadeIn("slow");a("#the-big-x").fadeIn("slow");a("#click-anywhere").delay(200).fadeIn("slow");a("#browse-marks").delay(100).fadeIn("slow");
b.animationComplete=!0})}}}})(jQuery);
