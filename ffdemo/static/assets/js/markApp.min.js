...
15,top:d.mouseY-a("#contributor-quote-box").height()-15}):(a("#contributor-quote-box:visible").fadeOut("fast"),b.hoverMark.color="255,111,40")}else if(b.hoverMark)b.hoverMark.color=b.hoverMark.contributor_name?"0,139,211":"0,0,0",b.hoverMark=null,a("#contributor-quote-box:visible").fadeOut("fast")},loop:function(d){var b=d.modules.linear,c=b.layerManager.layers.drawingLayer,e={x:b.scene.camera.position.x,y:b.scene.camera.position.y,z:b.scene.camera.position.z};if("cameraEase"in b.tweens)TWEEN.update();
else{b.cameraChange.vZ+=b.cameraChange.aZ;b.cameraChange.vX+=b.cameraChange.aX;b.cameraChange.vX*=0.93;b.cameraChange.vZ*=0.93;b.scene.camera.position.x+=b.cameraChange.vX;b.scene.camera.position.z+=b.cameraChange.vZ;var f=modules.linear.fn.closestMark(d);if(f){var g=b.scene.camera.position.y-(f.position.y+f.bHeight/2);g!=0&&Math.abs(g)>=10&&(b.scene.camera.position.y+=g>0?-10:10)}}if(!b.eventChange&&e.x==b.scene.camera.position.x&&e.y==b.scene.camera.position.y&&e.z==b.scene.camera.position.z)return!1;
if(b.hoverMark&&!modules.linear.fn.hoverTest(d,d.mouseX,d.mouseY,b.hoverMark))b.hoverMark.color=b.hoverMark.contributor_name?"0,139,211":"0,0,0",b.hoverMark=null,a("#contributor-quote-box:visible").fadeOut("fast");c.clean();modules.linear.fn.updateScene(d,b.scene.camera.position.x-1E4,b.scene.camera.position.x+1E4);modules.linear.fn.updateBuffers(d,b.scene.camera.position.x-1E4,b.scene.camera.position.x+1E4);Mark.renderer.renderScene(b.scene,{cursor:{x:d.mouseX,y:d.mouseY},width:d.width,height:d.height});
b.eventChange=!1;for(f in b.scene.timers)d=(new Date).getTime(),b.scene.timers[f].end<d&&delete b.scene.timers[f],b.eventChange=!0}},fn:{init:function(d,b){var c=d.modules.linear;if("$linear"in d.modules.linear){b.country_code!=c.country_code&&modules.linear.fn.dumpAllMarks(d);a.extend(c,c,b);for(option in modules.linear.defaults)b[option]==null&&(c[option]=modules.linear.defaults[option]);modules.linear.fn.updateInterface(d);modules.linear.fn.initMarks(d)}else a.extend(c,modules.linear.defaults,
b),a.extend(c,c,modules.linear.config),c.$linear=a("<div />").addClass("linear-container"),d.$container.append(c.$linear),c.scene=new Mark.scene,c.cameraChange={aX:0,aY:0,aZ:0,vX:0,vY:0,vZ:0},c.layerManager=new Mark.layerManager(c.$linear.get(0)),c.layerManager.addLayer("drawingLayer"),c.scene.canvasContext=c.layerManager.layers.drawingLayer.context,d.fn.trigger("resize"),c.initialized=!0;c.flaggings=d.fn.getData("markFlaggings")||{}},deinit:function(a){var b=a.modules.linear;b.$linear.fadeOut("fast",
function(){b.layerManager.removeAll();b.$linear.remove();b.initialized=!1})},initInterface:function(d){var b=d.modules.linear;a("#stats").hide();a("#mark-browsing-zoom-in a, #mark-browsing-zoom-out a, #mark-browsing-next a, #mark-browsing-prev a").click(function(a){a.preventDefault()}).bind("mouseup mouseout",function(b){b.preventDefault();if(a(this).data("mouseDown")){if(a(this).is("#mark-browsing-zoom-in a, #mark-browsing-zoom-out a"))d.modules.linear.cameraChange.aZ=0;else if(a(this).is("#mark-browsing-next a, #mark-browsing-prev a"))d.modules.linear.cameraChange.aX=
0;a(this).data("mouseDown",!1)}}).bind("mousedown",function(b){b.preventDefault();a(this).data("mouseDown",!0);if(a(this).is("#mark-browsing-zoom-in a, #mark-browsing-zoom-out a"))d.modules.linear.cameraChange.aZ=a(this).is("#mark-browsing-zoom-in a")?10:-10;else if(a(this).is("#mark-browsing-next a, #mark-browsing-prev a"))d.modules.linear.cameraChange.aX=a(this).is("#mark-browsing-next a")?10:-10,modules.linear.fn.hideMarkInformation(d)});d.fn.withCountryCodes(function(c){for(var e=a("#country-select"),
f=0;f<c.length;f++){var g=a("<option />").val(c[f].code).text(c[f].name);e.append(g)}e.change(function(){var c=a(this).val();c.length!=2&&b.country_code?d.app.setLocation("#/"+b.linear_root+"/"):c.length==2&&c!=b.country_code&&d.app.setLocation("#/"+b.linear_root+"/country/"+c+"/");a(this).blur();d.$container.focus()});b.country_code&&e.val(b.country_code)});a("#mark-information").hide();a("#mark-playback").click(function(a){a.preventDefault();modules.linear.fn.replayCurrentMark(d)});a("#mark-flag").click(function(a){a.preventDefault();
modules.linear.fn.flagCurrentMark(d)});a("#delete-mark").click(function(a){a.preventDefault();modules.linear.fn.deleteCurrentMark(d)});a("#approve-mark-checkbox").change(function(b){b.preventDefault();b=a(this).is(":checked");modules.linear.fn.approveCurrentMark(d,b)});a("#twitter-share").socialShare({share_url:"http://twitter.com/share",share_params:{text:d.fn.getString("twitter-msg")}});a("#facebook-share").socialShare({share_url:"http://www.facebook.com/sharer.php",share_params:{t:d.fn.getString("facebook-msg")}});
modules.linear.fn.updateInterface(d);modules.linear.fn.initMarks(d);a("#sammy #country-select").selectBox({autoWidth:!1});a("#sammy #contributor-select").selectBox({autoWidth:!1})},initMarks:function(a){var b=a.modules.linear;b.reference_mark&&b.reference_mark!=""?b.reference_mark in b.marks?modules.linear.fn.jumpToMark(a,b.reference_mark,b.playback):modules.linear.fn.loadMarks(a,{reference:b.reference_mark,include_forward:20,include_back:20,include_mark:1,success:function(c){c.success?(modules.linear.fn.setupMarks(a,
c.marks),modules.linear.fn.jumpToMark(a,b.reference_mark,b.playback)):a.fn.showError(b.errorMsg);b.requestingMarks=!1}}):modules.linear.fn.loadMarks(a,{offset:0,max:20,success:function(c){if(c.success){if(modules.linear.fn.setupMarks(a,c.marks),firstMark=b.marks[c.marks[0].reference])b.scene.camera.position.x=-4E3,b.scene.camera.position.z=-3E3,c="cameraEase"in b.tweens?b.tweens.cameraEase:new TWEEN.Tween(b.scene.camera.position),c.to({x:firstMark.bWidth/2,y:firstMark.bHeight/2,z:-1E3},2E3).onComplete(function(){delete b.tweens.cameraEase;
typeof callback==="function"&&callback(this)}).easing(TWEEN.Easing.Quartic.EaseInOut).start(),b.tweens.cameraEase=c}else a.fn.showError(b.errorMsg);b.requestingMarks=!1}})},updateInterface:function(d){var b=d.modules.linear,c=d.fn.getData("userMark");c&&(b.country_code?c.country_code==b.country_code:1)?a("#your-mark-link").attr("href","#/"+b.linear_root+"/"+d.fn.getData("userMark").reference).show():a("#your-mark-link").hide();var e={};b.country_code?(e.country_code=b.country_code,a("#contributor-select").next().hide(),
a("#contributor-select-label").hide()):(a("#contributor-select").next().show(),a("#contributor-select-label").show());a("#mark-browsing-options").is(".country-"+(b.country_code?b.country_code:"all"))||a.ajax({url:"/requests/init_viz_data",data:e,dataType:"JSON",success:function(c){a("#mark-browsing-options").removeAttr("class").addClass("country-"+(b.country_code?b.country_code:"all"));a("#stats-number-of-marks").text(c.total_marks);a("#stats-number-of-countries").text(c.total_countries);var g=new Date(c.first_mark_at);
g=Math.ceil(((new Date).getTime()-g.getTime())/864E5);a("#stats-number-of-days").text(g);a("#stats").fadeIn("fast");b.country_code?(a("#first-mark-link").attr("href","#/"+b.linear_root+"/country/"+b.country_code+"/"+c.country_first_mark),a("#last-mark-link").attr("href","#/"+b.linear_root+"/country/"+b.country_code+"/"+c.country_last_mark)):(a("#first-mark-link").attr("href","#/"+b.linear_root+"/"+c.first_mark),a("#last-mark-link").attr("href","#/"+b.linear_root+"/"+c.last_mark));a("#mark-browsing").collapsibleMod();
a("#stats").collapsibleMod({collapsedHeight:10});if(a("#contributor-select option").size()==1){g=a("#contributor-select");if(c.contributor_marks)for(var h=0;h<c.contributor_marks.length;h++){var i=a("<option />").val(c.contributor_marks[h].reference).text(c.contributor_marks[h].contributor);g.append(i)}g.change(function(){var c=a(this).val();c.length!="label"&&d.app.setLocation("#/"+b.linear_root+"/"+c);a(this).blur();d.$container.focus()});b.country_code?(e.country_code=b.country_code,a("#contributor-select").next().hide(),
a("#contributor-select-label").hide()):(a("#contributor-select").next().show(),a("#contributor-select-label").show())}}})},dumpAllMarks:function(a){a=a.modules.linear;for(mark in a.marks)delete a.marks[mark];a.scene.objects=[];a.leftBuffer=[];a.rightBuffer=[];a.moreRight=!0;a.moreLeft=!0;a.scene.camera.position.x=0;a.scene.camera.position.y=0;a.scene.camera.position.z=-1E3},loadMarks:function(d,b){var c=d.modules.linear,e=b.success;delete b.success;if(c.country_code)b.country_code=c.country_code;
var f=b.reference?"/requests/marks_by_reference":"/requests/all_marks";c.is_flagged&&(f="/requests/marks_by_flagged");b.reference&&!(b.reference in c.marks)?(modules.linear.fn.dumpAllMarks(d),d.fn.showLoader(d.fn.getString("loading-marks-msg"),"overlay-light")):b.reference||d.fn.showLoader(d.fn.getString("loading-marks-msg"),"overlay-light");a.ajax({url:f,data:b,dataType:"JSON"}).success(e).success(function(){d.fn.hideLoader()})},setupMarks:function(a,b){var c=a.modules.linear;if(b.length!=0){for(var e=
0;e<b.length;e++)b[e].reference in c.marks&&b.shift(e,1);e=[];for(var f in c.marks)e.push([f,c.marks[f].id]);e.sort(function(a,b){return a[1]-b[1]});var g=e.length==0||e[0][1]<b[0].id?c.rightBuffer:c.leftBuffer,h=g==c.leftBuffer?!0:!1;h&&b.reverse();var i=g.length>0?c.marks[g[h?0:g.length-1]]:c.scene.objects[h?0:c.scene.objects.length-1];for(e=0;e<b.length;e++)if(!(b[e].reference in c.marks)){var j=JSON.parse(b[e].points_obj_simplified);if("strokes"in j&&!(j.strokes.length==0||j.strokes[0].length<
2)){f=new Mark.gmlMark(j.strokes,b[e].reference,b[e].country_code,b[e].date_drawn,j.rtl,b[e].id,b[e].is_approved);if(b[e].contributor)f.contributor_name=b[e].contributor,f.extra_info=j.extra_info,f.color="0,139,211";c.marks[f.reference]=f;i&&f.positionRelativeTo(i,h);h?g.unshift(f.reference):g.push(f.reference);i=f}}}},refillBuffer:function(a,b){var c=a.modules.linear;if(!c.requestingMarks){c.requestingMarks=!0;var e=b==c.leftBuffer,f=null;f=b.length>0?c.marks[b[e?0:b.length-1]]:c.scene.objects[e?
0:c.scene.objects.length-1];modules.linear.fn.loadMarks(a,{reference:f.reference,include_forward:e?0:20,include_back:e?20:0,include_mark:0,success:function(b){b.success?(modules.linear.fn.setupMarks(a,b.marks),b.marks.length==0&&(c[e?"moreLeft":"moreRight"]=!1)):c[e?"moreLeft":"moreRight"]=!1;c.requestingMarks=!1}})}},updateBuffers:function(a,b,c){var e=a.modules.linear;if(e.scene.objects.length!=0){for(var f=e.scene.objects[0];f&&f.position.x+f.bWidth<b;)e.leftBuffer.push(e.scene.objects.shift().reference),
...
var c=b.currentMark;a("#mark-id").text(c.id);var e=new Date(c.time),f=[];f.push(d.fn.getString("month-abbreviations",e.getMonth())+" "+e.getDate());f.push(e.getHours()+":"+(String(e.getMinutes()).length==1?"0"+e.getMinutes():e.getMinutes()));c.country_code?d.fn.withCountryCodes(function(b){a("#mark-country").text(" / "+b[c.country_code])}):a("#mark-country").text("");c.contributor_name?(a("#mark-contributor-name").text("- "+c.contributor_name),a("#mark-flag").hide(),a("#contributor-quote").text(c.extra_info).html("&#8220;"+
a("#contributor-quote").text()+"&#8221;"),a("#contributor-name").text("- "+c.contributor_name)):(a("#mark-contributor-name, #contributor-quote, #contributor-name").text(""),a("#mark-flag").show());a("#mark-timestamp").text(f.join(" / "));a("#url-share input").val(window.location.href);if(b.linear_root!="moderate")a("#twitter-share").data("socialShare-context").share_params.url=window.location.href,a("#facebook-share").data("socialShare-context").share_params.u=window.location.href;b.linear_root==
"moderate"&&a("#approve-mark-checkbox").attr("checked",c.is_approved);b.currentMark.reference in b.flaggings?a("#mark-flag").addClass("disabled"):a("#mark-flag").removeClass("disabled");a("#mark-information").fadeIn("fast")},hideMarkInformation:function(){a("#mark-information").fadeOut("fast")},replayCurrentMark:function(a){a=a.modules.linear;var b=(new Date).getTime();a.eventChange=!0;a.scene.timers[a.currentMark.reference]={start:b,end:b+a.currentMark.maxTime,speed:1}},flagCurrentMark:function(d){var b=
d.modules.linear;b.currentMark.reference in b.flaggings||a.ajax({url:"/requests/flag_mark",data:{reference:b.currentMark.reference},type:"POST",dataType:"JSON",success:function(){a("#mark-flag").addClass("disabled");b.flaggings[b.currentMark.reference]=!0;d.fn.storeData("markFlaggings",b.flaggings)},error:function(){d.fn.showError(b.errorMsg)}})},deleteCurrentMark:function(d){var b=d.modules.linear;a.ajax({url:"/requests/delete_mark",data:{reference:b.currentMark.reference},type:"POST",dataType:"JSON",
success:function(){var a=b.currentMark.reference,e=null;delete b.marks[b.currentMark.reference];b.currentMark=null;for(var f=0;f<b.scene.objects.length;f++)if(e||b.scene.objects[f].reference==a){if(!e)e=f,b.scene.objects.splice(f,1),b.currentMark=b.scene.objects[f];f==0?b.scene.objects[f].positionToStart():b.scene.objects[f].positionRelativeTo(b.scene.objects[f-1])}d.app.setLocation("#/"+b.linear_root+"/"+b.currentMark.reference);b.eventChange=!0},error:function(){d.fn.showError(b.errorMs)}})},approveCurrentMark:function(d,
b){var c=d.modules.linear;a.ajax({url:"/requests/approve_mark",data:{reference:c.currentMark.reference,should_approve:b},type:"POST",dataType:"JSON",success:function(){c.currentMark.is_approved=b},error:function(){d.fn.showError(c.errorMsg)}})},centerCurrentMark:function(a,b){var c=a.modules.linear;if(!c.currentMark)return!1;modules.linear.fn.showMarkInformation(a);c.cameraChange.aX=0;c.cameraChange.vX=0;c.cameraChange.aZ=0;c.cameraChange.vZ=0;var e=Math.abs(c.currentMark.position.x-c.scene.camera.position.x)/
