...
b.country_code+"/"+mark.reference):a.app.setLocation("#/"+b.linear_root+"/"+mark.reference)},mousemove:function(e){var b=e.modules.linear;b.eventChange=!0;if(mark=modules.linear.fn.hoverTest(e,e.mouseX,e.mouseY,b.hoverMark)){if(b.hoverMark)b.hoverMark.color=b.hoverMark.contributor_name?"0,139,211":"0,0,0";b.hoverMark=mark;b.currentMark&&b.hoverMark.reference==b.currentMark.reference&&b.hoverMark.contributor_name&&a("#mark-information").is(":visible")?a("#contributor-quote-box").fadeIn("fast").css({left:e.mouseX-
15,top:e.mouseY-a("#contributor-quote-box").height()-15}):(a("#contributor-quote-box:visible").fadeOut("fast"),b.hoverMark.color="255,111,40")}else if(b.hoverMark)b.hoverMark.color=b.hoverMark.contributor_name?"0,139,211":"0,0,0",b.hoverMark=null,a("#contributor-quote-box:visible").fadeOut("fast")},loop:function(e){var b=e.modules.linear,c=b.layerManager.layers.drawingLayer,f={x:b.scene.camera.position.x,y:b.scene.camera.position.y,z:b.scene.camera.position.z};if("cameraEase"in b.tweens)TWEEN.update();
else{b.cameraChange.vZ+=b.cameraChange.aZ;b.cameraChange.vX+=b.cameraChange.aX;b.cameraChange.vX*=0.93;b.cameraChange.vZ*=0.93;b.scene.camera.position.x+=b.cameraChange.vX;b.scene.camera.position.z+=b.cameraChange.vZ;var g=modules.linear.fn.closestMark(e);if(g){var h=b.scene.camera.position.y-(g.position.y+g.bHeight/2);h!=0&&Math.abs(h)>=10&&(b.scene.camera.position.y+=h>0?-10:10)}}if(!b.eventChange&&f.x==b.scene.camera.position.x&&f.y==b.scene.camera.position.y&&f.z==b.scene.camera.position.z)return!1;
if(b.hoverMark&&!modules.linear.fn.hoverTest(e,e.mouseX,e.mouseY,b.hoverMark))b.hoverMark.color=b.hoverMark.contributor_name?"0,139,211":"0,0,0",b.hoverMark=null,a("#contributor-quote-box:visible").fadeOut("fast");c.clean();modules.linear.fn.updateScene(e,b.scene.camera.position.x-1E4,b.scene.camera.position.x+1E4);modules.linear.fn.updateBuffers(e,b.scene.camera.position.x-1E4,b.scene.camera.position.x+1E4);Mark.renderer.renderScene(b.scene,{cursor:{x:e.mouseX,y:e.mouseY},width:e.width,height:e.height});
b.eventChange=!1;for(g in b.scene.timers)e=(new Date).getTime(),b.scene.timers[g].end<e&&delete b.scene.timers[g],b.eventChange=!0}},fn:{init:function(e,b){var c=e.modules.linear;if("$linear"in e.modules.linear){b.country_code!=c.country_code&&modules.linear.fn.dumpAllMarks(e);a.extend(c,c,b);for(option in modules.linear.defaults)b[option]==null&&(c[option]=modules.linear.defaults[option]);modules.linear.fn.updateInterface(e);modules.linear.fn.initMarks(e)}else a.extend(c,modules.linear.defaults,
b),a.extend(c,c,modules.linear.config),c.$linear=a("<div />").addClass("linear-container"),e.$container.append(c.$linear),c.scene=new Mark.scene,c.cameraChange={aX:0,aY:0,aZ:0,vX:0,vY:0,vZ:0},c.layerManager=new Mark.layerManager(c.$linear.get(0)),c.layerManager.addLayer("drawingLayer"),c.scene.canvasContext=c.layerManager.layers.drawingLayer.context,e.fn.trigger("resize"),c.initialized=!0;c.flaggings=e.fn.getData("markFlaggings")||{}},deinit:function(a){var b=a.modules.linear;b.$linear.fadeOut("fast",
function(){b.layerManager.removeAll();b.$linear.remove();b.initialized=!1})},initInterface:function(e){var b=e.modules.linear;a("#stats").hide();a("#mark-browsing-zoom-in a, #mark-browsing-zoom-out a, #mark-browsing-next a, #mark-browsing-prev a").click(function(a){a.preventDefault()}).bind("mouseup mouseout",function(b){b.preventDefault();if(a(this).data("mouseDown")){if(a(this).is("#mark-browsing-zoom-in a, #mark-browsing-zoom-out a"))e.modules.linear.cameraChange.aZ=0;else if(a(this).is("#mark-browsing-next a, #mark-browsing-prev a"))e.modules.linear.cameraChange.aX=
0;a(this).data("mouseDown",!1)}}).bind("mousedown",function(b){b.preventDefault();a(this).data("mouseDown",!0);if(a(this).is("#mark-browsing-zoom-in a, #mark-browsing-zoom-out a"))e.modules.linear.cameraChange.aZ=a(this).is("#mark-browsing-zoom-in a")?10:-10;else if(a(this).is("#mark-browsing-next a, #mark-browsing-prev a"))e.modules.linear.cameraChange.aX=a(this).is("#mark-browsing-next a")?10:-10,modules.linear.fn.hideMarkInformation(e)});e.fn.withCountryCodes(function(c){for(var f=a("#country-select"),
g=0;g<c.length;g++){var h=a("<option />").val(c[g].code).text(c[g].name);f.append(h)}f.change(function(){var c=a(this).val();c.length!=2&&b.country_code?e.app.setLocation("#/"+b.linear_root+"/"):c.length==2&&c!=b.country_code&&e.app.setLocation("#/"+b.linear_root+"/country/"+c+"/");a(this).blur();a(".ui-selectBox-focus").removeClass("ui-selectBox-focus");e.$container.focus()});b.country_code&&f.val(b.country_code)});a("#mark-information").hide();a("#mark-playback").click(function(a){a.preventDefault();
modules.linear.fn.replayCurrentMark(e)});a("#mark-gml-download").click(function(a){a.preventDefault();modules.linear.fn.downloadCurrentMark(e)});a("#mark-flag").click(function(a){a.preventDefault();modules.linear.fn.flagCurrentMark(e)});a("#delete-mark").click(function(a){a.preventDefault();modules.linear.fn.deleteCurrentMark(e)});a("#approve-mark-checkbox").change(function(b){b.preventDefault();b=a(this).is(":checked");modules.linear.fn.approveCurrentMark(e,b)});a("#twitter-share").socialShare({share_url:"http://twitter.com/share",
share_params:{text:e.fn.getString("twitter-msg")}});a("#facebook-share").socialShare({share_url:"http://www.facebook.com/sharer.php",share_params:{t:e.fn.getString("facebook-msg")}});modules.linear.fn.updateInterface(e);modules.linear.fn.initMarks(e);a("#sammy #country-select").selectBox({autoWidth:!1});a("#sammy #contributor-select").selectBox({autoWidth:!1})},initMarks:function(a){var b=a.modules.linear;b.reference_mark&&b.reference_mark!=""?b.reference_mark in b.marks?modules.linear.fn.jumpToMark(a,
b.reference_mark,b.playback):modules.linear.fn.loadMarks(a,{reference:b.reference_mark,include_forward:20,include_back:20,include_mark:1,success:function(c){c.success?(modules.linear.fn.setupMarks(a,c.marks),modules.linear.fn.jumpToMark(a,b.reference_mark,b.playback)):a.fn.showError(a.fn.getString("no-marks-error-msg"));b.requestingMarks=!1}}):modules.linear.fn.loadMarks(a,{offset:0,max:20,success:function(c){if(c.success){if(modules.linear.fn.setupMarks(a,c.marks),firstMark=b.marks[c.marks[0].reference])b.scene.camera.position.x=
-4E3,b.scene.camera.position.z=-3E3,c="cameraEase"in b.tweens?b.tweens.cameraEase:new TWEEN.Tween(b.scene.camera.position),c.to({x:firstMark.bWidth/2,y:firstMark.bHeight/2,z:-1E3},2E3).onComplete(function(){delete b.tweens.cameraEase;typeof callback==="function"&&callback(this)}).easing(TWEEN.Easing.Quartic.EaseInOut).start(),b.tweens.cameraEase=c}else a.fn.showError(a.fn.getString("no-marks-error-msg"));b.requestingMarks=!1}})},updateInterface:function(e){var b=e.modules.linear,c=e.fn.getData("userMark");
c&&(b.country_code?c.country_code==b.country_code:1)?a("#your-mark-link").attr("href","#/"+b.linear_root+"/"+e.fn.getData("userMark").reference).show():a("#your-mark-link").hide();var f={};b.country_code?(f.country_code=b.country_code,a("#contributor-select").next().hide(),a("#contributor-select-label").hide()):(a("#contributor-select").next().show(),a("#contributor-select-label").show());b.linear_root!="moderate"&&!a("#mark-browsing-options").is(".country-"+(b.country_code?b.country_code:"all"))&&
a.ajax({url:"/requests/init_viz_data",data:f,dataType:"JSON",success:function(c){a("#mark-browsing-options").removeAttr("class").addClass("country-"+(b.country_code?b.country_code:"all"));b.country_code?(a("#first-mark-link").attr("href","#/"+b.linear_root+"/country/"+b.country_code+"/"+c.country_first_mark),a("#last-mark-link").attr("href","#/"+b.linear_root+"/country/"+b.country_code+"/"+c.country_last_mark)):(a("#first-mark-link").attr("href","#/"+b.linear_root+"/"+c.first_mark),a("#last-mark-link").attr("href",
"#/"+b.linear_root+"/"+c.last_mark));a("#mark-browsing").collapsibleMod();a("#total-mark-count").text(c.max_id);if(a("#contributor-select option").size()==1){var h=a("#contributor-select");if(c.contributor_marks)for(var i=0;i<c.contributor_marks.length;i++){var j=a("<option />").val(c.contributor_marks[i].reference).text(c.contributor_marks[i].contributor);h.append(j)}h.change(function(){var c=a(this).val();c!="label"&&e.app.setLocation("#/"+b.linear_root+"/"+c);a(this).blur();e.$container.focus()});
b.country_code?(f.country_code=b.country_code,a("#contributor-select").next().hide(),a("#contributor-select-label").hide()):(a("#contributor-select").next().show(),a("#contributor-select-label").show())}}})},dumpAllMarks:function(a){a=a.modules.linear;for(mark in a.marks)delete a.marks[mark];a.scene.objects=[];a.leftBuffer=[];a.rightBuffer=[];a.moreRight=!0;a.moreLeft=!0;a.scene.camera.position.x=0;a.scene.camera.position.y=0;a.scene.camera.position.z=-1E3},loadMarks:function(e,b){var c=e.modules.linear,
f=b.success;delete b.success;if(c.country_code)b.country_code=c.country_code;var g=b.reference?"/requests/marks_by_reference":"/requests/all_marks";c.is_flagged&&(g="/requests/marks_by_flagged");b.reference&&!(b.reference in c.marks)?(modules.linear.fn.dumpAllMarks(e),e.fn.showLoader(e.fn.getString("loading-marks-msg"),"overlay-light")):b.reference||e.fn.showLoader(e.fn.getString("loading-marks-msg"),"overlay-light");a.ajax({url:g,data:b,dataType:"JSON"}).success(f).success(function(){e.fn.hideLoader()})},
setupMarks:function(a,b){var c=a.modules.linear;if(b.length!=0){for(var f=0;f<b.length;f++)b[f].reference in c.marks&&b.shift(f,1);f=[];for(var g in c.marks)f.push([g,c.marks[g].id]);f.sort(function(a,b){return a[1]-b[1]});var h=f.length==0||f[0][1]<b[0].id?c.rightBuffer:c.leftBuffer,i=h==c.leftBuffer?!0:!1;i&&b.reverse();var j=h.length>0?c.marks[h[i?0:h.length-1]]:c.scene.objects[i?0:c.scene.objects.length-1];for(f=0;f<b.length;f++)if(!(b[f].reference in c.marks)){var k=JSON.parse(b[f].points_obj_simplified);
if(!(k==null||!("strokes"in k)||k.strokes.length==0||k.strokes[0].length<2)){g=new Mark.gmlMark(k.strokes,b[f].reference,b[f].country_code,b[f].date_drawn,k.rtl,b[f].id,b[f].is_approved);if(b[f].contributor)g.contributor_name=b[f].contributor,g.extra_info=k.extra_info,g.contributor_url=k.contributor_url,g.color="0,139,211";c.marks[g.reference]=g;j&&g.positionRelativeTo(j,i);i?h.unshift(g.reference):h.push(g.reference);j=g}}}},refillBuffer:function(a,b){var c=a.modules.linear;if(!c.requestingMarks){c.requestingMarks=
!0;var f=b==c.leftBuffer,g=null;g=b.length>0?c.marks[b[f?0:b.length-1]]:c.scene.objects[f?0:c.scene.objects.length-1];modules.linear.fn.loadMarks(a,{reference:g.reference,include_forward:f?0:20,include_back:f?20:0,include_mark:0,success:function(b){b.success?(modules.linear.fn.setupMarks(a,b.marks),b.marks.length<18&&(c[f?"moreLeft":"moreRight"]=!1)):c[f?"moreLeft":"moreRight"]=!1;c.requestingMarks=!1}})}},updateBuffers:function(a,b,c){var f=a.modules.linear;if(f.scene.objects.length!=0){for(var g=
f.scene.objects[0];g&&g.position.x+g.bWidth<b;)f.leftBuffer.push(f.scene.objects.shift().reference),g=f.scene.objects[0];for(g=f.scene.objects[f.scene.objects.length-1];g&&g.position.x>c;)f.rightBuffer.unshift(f.scene.objects.pop().reference),g=f.scene.objects[f.scene.objects-1];f.leftBuffer.length<5&&f.scene.objects.length>0&&f.moreLeft&&!f.requestingMarks?modules.linear.fn.refillBuffer(a,f.leftBuffer):f.rightBuffer.length<5&&f.scene.objects.length>0&&f.moreRight&&!f.requestingMarks&&modules.linear.fn.refillBuffer(a,
f.rightBuffer)}},updateScene:function(a,b,c){a=a.modules.linear;if(a.rightBuffer.length>0)for(var f=a.marks[a.rightBuffer[0]];f&&f.position&&f.position.x<c;)a.scene.objects.push(a.marks[a.rightBuffer.shift()]),f=a.rightBuffer[0];if(a.leftBuffer.length>0)for(f=a.marks[a.leftBuffer[a.leftBuffer.length-1]];f&&f.position&&f.position.x+f.bWidth>b;)a.scene.objects.unshift(a.marks[a.leftBuffer.pop()]),f=a.leftBuffer[a.leftBuffer.length-1]},jumpToMark:function(a,b,c){var f=a.modules.linear;f.currentMark=
f.marks[b];if(c){var g=(new Date).getTime()*2;f.scene.timers[b]={start:g,end:g+f.currentMark.maxTime,speed:1}}modules.linear.fn.centerCurrentMark(a,function(){c&&modules.linear.fn.replayCurrentMark(a);modules.linear.fn.showMarkInformation(a)})},closestMark:function(a){a=a.modules.linear;for(var b=a.scene.objects[0],c=1;c<a.scene.objects.length;c++){var f=a.scene.objects[c];Math.abs(a.scene.camera.position.x-(f.position.x+f.bWidth/2))<Math.abs(a.scene.camera.position.x-(b.position.x+b.bWidth/2))&&
(b=f)}return b},hoverTest:function(a,b,c,f){if(f&&f.renderedBounds&&b>=f.renderedBounds.minX&&b<=f.renderedBounds.maxX&&c>=f.renderedBounds.minY&&c<=f.renderedBounds.maxY)return f;return modules.linear.fn.hitTest(a,b,c)},hitTest:function(a,b,c){a=a.modules.linear;for(var f=0;f<a.scene.objects.length;f++)if(a.scene.objects[f].renderedBounds&&b>=a.scene.objects[f].renderedBounds.minX&&b<=a.scene.objects[f].renderedBounds.maxX&&c>=a.scene.objects[f].renderedBounds.minY&&c<=a.scene.objects[f].renderedBounds.maxY)return a.scene.objects[f];
return!1},showMarkInformation:function(e){var b=e.modules.linear;if(!b.currentMark)return!1;var c=b.currentMark;a("#mark-id").text(c.id);var f=new Date(c.time);f=new Date(f.getTime()+36E5*e.timezoneOffset);var g=[];g.push(f.getHours()+":"+(String(f.getMinutes()).length==1?"0"+f.getMinutes():f.getMinutes()));g.push("GMT");g.push(e.fn.getString("month-abbreviations",f.getMonth())+" "+f.getDate()+", "+f.getFullYear());c.country_code?e.fn.withCountryCodes(function(b){c.country_code in b?a("#mark-country").text(" / "+
b[c.country_code]):a("#mark-country").text("")}):a("#mark-country").text("");c.contributor_name?(a("#mark-contributor-name").text(c.contributor_name),a("#contributor-name").text(c.contributor_name),a("#mark-flag").hide(),"extra_info"in c&&c.extra_info!=null&&c.extra_info!=""&&a("#contributor-quote").text("\u201c"+c.extra_info+"\u201d"),"contributor_url"in c&&e.fn.validate.url(c.contributor_url)?a("#mark-contributor-url").text(c.contributor_url.replace(/(ftp|http|https):\/\//,"").replace(/\/$/,"")).attr("href",
c.contributor_url):a("#mark-contributor-url").text("").attr("href",""),a("#contributor-information").show()):(a("#mark-contributor-name, #contributor-quote, #contributor-name, #mark-contributor-url").text(""),a("#contributor-information").hide(),a("#mark-flag").show());a("#mark-timestamp").text(g.join(" "));a("#url-share input").val(window.location.href);if(b.linear_root!="moderate")a("#twitter-share").data("socialShare-context").share_params.url=window.location.href,a("#facebook-share").data("socialShare-context").share_params.u=
...
a.modules.linear;var b=(new Date).getTime();a.eventChange=!0;a.scene.timers[a.currentMark.reference]={start:b,end:b+a.currentMark.maxTime,speed:1}},downloadCurrentMark:function(a){a=a.modules.linear;a.currentMark&&a.currentMark.reference&&window.open("/gml/"+a.currentMark.reference)},flagCurrentMark:function(e){var b=e.modules.linear;b.currentMark.reference in b.flaggings||a.ajax({url:"/requests/flag_mark",data:{reference:b.currentMark.reference},type:"POST",dataType:"JSON",success:function(){a("#mark-flag").addClass("disabled");
b.flaggings[b.currentMark.reference]=!0;e.fn.storeData("markFlaggings",b.flaggings)},error:function(){e.fn.showError(e.fn.getString("error-msg"))}})},deleteCurrentMark:function(e){var b=e.modules.linear;a.ajax({url:"/requests/delete_mark",data:{reference:b.currentMark.reference},type:"POST",dataType:"JSON",success:function(){var a=b.currentMark.reference,f=null;delete b.marks[b.currentMark.reference];b.currentMark=null;for(var g=0;g<b.scene.objects.length;g++)if(f||b.scene.objects[g].reference==a){if(!f)f=
g,b.scene.objects.splice(g,1),b.currentMark=b.scene.objects[g];g==0?b.scene.objects[g].positionToStart():b.scene.objects[g].positionRelativeTo(b.scene.objects[g-1])}e.app.setLocation("#/"+b.linear_root+"/"+b.currentMark.reference);b.eventChange=!0},error:function(){e.fn.showError(e.fn.getString("error-msg"))}})},approveCurrentMark:function(e,b){var c=e.modules.linear;a.ajax({url:"/requests/approve_mark",data:{reference:c.currentMark.reference,should_approve:b},type:"POST",dataType:"JSON",success:function(){c.currentMark.is_approved=
b},error:function(){e.fn.showError(e.fn.getString("error-msg"))}})},centerCurrentMark:function(a,b){var c=a.modules.linear;if(!c.currentMark)return!1;modules.linear.fn.showMarkInformation(a);c.cameraChange.aX=0;c.cameraChange.vX=0;c.cameraChange.aZ=0;c.cameraChange.vZ=0;var f=Math.abs(c.currentMark.position.x-c.scene.camera.position.x)/2;f=Math.max(1E3,f);var g="cameraEase"in c.tweens?c.tweens.cameraEase:new TWEEN.Tween(c.scene.camera.position);g.to({x:c.currentMark.position.x+c.currentMark.bWidth/
2,y:c.currentMark.position.y+c.currentMark.bHeight/2,z:c.currentMark.position.z-1E3},f).onComplete(function(){delete c.tweens.cameraEase;typeof b==="function"&&b(this)}).easing(f>1200?TWEEN.Easing.Quadratic.EaseInOut:TWEEN.Easing.Quartic.EaseInOut).start();c.tweens.cameraEase=g}}}})(jQuery);
