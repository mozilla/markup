...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
       db.execute("CREATE INDEX duplicate_check_index ON markup_mark(duplicate_check)")
       db.execute("CREATE INDEX contributor_locale_index ON markup_mark(contributor_locale)")
       db.execute("CREATE INDEX contributor_index ON markup_mark(contributor)")
       db.execute("CREATE INDEX reference_index ON markup_mark(reference)")
