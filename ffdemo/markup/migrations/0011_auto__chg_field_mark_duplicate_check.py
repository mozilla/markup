...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mark.duplicate_check'
        db.alter_column('markup_mark', 'duplicate_check', self.gf('django.db.models.fields.BigIntegerField')())
    
    
    def backwards(self, orm):
        
        # Changing field 'Mark.duplicate_check'
        db.alter_column('markup_mark', 'duplicate_check', self.gf('django.db.models.fields.IntegerField')())
